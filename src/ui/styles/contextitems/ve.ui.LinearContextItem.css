...
.ve-ui-mobileContext .ve-ui-linearContextItem-head > .oo-ui-buttonWidget {
	margin: 0 0.5em;
}

.ve-ui-mobileContext .ve-ui-linearContextItem-empty .ve-ui-linearContextItem-head > .oo-ui-buttonWidget {
	margin: 0.5em;
}
