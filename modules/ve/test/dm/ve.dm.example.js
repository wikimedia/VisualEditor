...
ve.dm.example.withMeta = [
	...
	'o',
	{
		...
		'htmlAttributes': [
			{
				'keys': [ 'rel', 'href' ],
				'values': { 'rel': 'mw:WikiLink/Category', 'href': './Category:Bar' }
			}
		]
	},
	{ 'type': '/mwCategory' },
...
ve.dm.example.domToDataCases = {
			...
			'<body>' +
				'<p>Foo' +
					...
					'<span id="cite_ref-3-0" class="reference" about="#mwt8" typeof="mw:Extension/ref" ' +
						'data-parsoid="{&quot;src&quot;:&quot;<ref group=\\&quot;g1\\&quot;>No name</ref>&quot;}"' +
				...
				'<ol class="references" typeof="mw:Extension/references" ' +
					...
					'data-parsoid="{&quot;src&quot:&quot;<references />&quot;}">' +
	...
	'div set to RTL with paragraph inside': {
		...
		'data': [
			{
				'type': 'div',
				'htmlAttributes': [ { 'keys': [ 'style' ], 'values': { 'style': 'direction: rtl;' } } ]
			},
			{ 'type': 'paragraph' },
			'a',
			['b', [ ve.dm.example.bold ]],
