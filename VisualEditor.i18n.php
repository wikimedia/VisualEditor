...
{{Identical|Male}}',
	...
	'tag-visualeditor' => '[[{{int:visualeditor-descriptionpagelink}}|Визуальный редактор]]',
...
$messages['af'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|Visuele teksverwerker]]', # Fuzzy
	'tag-visualeditor-description' => 'Wysiging gemaak met die [[{{int:Visualeditor-descriptionpagelink}}|visuele teksverwerker]]', # Fuzzy
	'tag-visualeditor-needcheck-description' => 'Wysiging gemaak met die [[{{int:Visualeditor-descriptionpagelink}}|visuele teksverwerker]] waar die stelsel potensieel onbedoelde veranderings opgespoor het.', # Fuzzy
	...
	'visualeditor-preference-enable' => 'Aktiveer die visuele tekstverwerker (slegs vir die [[{{int:Visualeditor-mainnamespacepagelink}}|hoof-]] en [[{{int:Visualeditor-usernamespacepagelink}}|gebruikersnaamruimte]])', # Fuzzy
 ...
 */
$messages['ar'] = array(
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|المحرر المرئي]]', # Fuzzy
	'tag-visualeditor-description' => 'أجري التعديل باستخدام [[{{int:Visualeditor-descriptionpagelink}}|المحرر المرئي]]', # Fuzzy
	...
	'visualeditor-preference-enable' => 'مكّن المحرر المرئي (في النطاقين [[{{int:Visualeditor-mainnamespacepagelink}}|الرئيس]] و[[{{int:Visualeditor-usernamespacepagelink}}|المستخدم]] فقط)', # Fuzzy
...
$messages['ast'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-description' => 'Edición fecha usando [[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor: Check]]', # Fuzzy
	'tag-visualeditor-needcheck-description' => "Edición fecha usando [[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]] na que'l sistema detectó que'l testu wiki pue tener cambeos non deseaos.", # Fuzzy
	...
	'visualeditor-beta-label' => 'beta',
	'visualeditor-beta-warning' => "VisualEditor ta en 'beta'. Pue atopase problemes de software y, seique, podría nun ser a editar partes de la páxina. Calque «Editar la fonte» pa cambiar al mou de testu wiki – perderá los cambios ensin guardar.", # Fuzzy
	...
	'visualeditor-preference-enable' => "Activar l'editor visual (sólo nos espacios de nomes [[{{int:Visualeditor-mainnamespacepagelink}}|principal]] y [[{{int:Visualeditor-usernamespacepagelink}}|d'usuariu]])", # Fuzzy
...
$messages['az'] = array(
	...
	'tag-visualeditor' => '[[{{int:visualeditor-descriptionpagelink}}|Vizual redaktor]]',
	'tag-visualeditor-description' => 'Redaktə [[{{int:visualeditor-descriptionpagelink}}|Vizual redaktorun]] köməyi ilə edilib',
	'tag-visualeditor-needcheck' => '[[{{int:visualeditor-descriptionpagelink}}|Vizual redaktor: Yoxla]]',
...
Шуға ҡарамаҫтан, был баһалама һөҙөмтәләрен аноним һәм дөйөмләштерелгән рәүештә тарата алабыҙ.',
	...
	'tag-visualeditor' => '[[{{int:visualeditor-descriptionpagelink}}|Күҙләгес мөхәррир]]',
	'tag-visualeditor-description' => 'Төҙәтеү [[{{int:visualeditor-descriptionpagelink}}|Күҙләгес мөхәррир]] ҡулланып башҡарылған',
	'tag-visualeditor-needcheck' => '[[{{int:visualeditor-descriptionpagelink}}|Күҙләгес мөхәррир: Тикшерергә]]',
	'tag-visualeditor-needcheck-description' => 'Система [[{{int:visualeditor-descriptionpagelink}}|Күҙләгес мөхәррир]]е ҡулланып төҙәтеү эшләгәндә викитекста осраҡлы үҙгәртеүҙәр булыуын асыҡланы.',
	...
	'visualeditor-languageinspector-block-tooltip' => 'Тел блогы: $1$2',
	...
	'visualeditor-preference-enable' => 'Күҙләгес мөхәррирҙе ҡулланырға ([[{{int:visualeditor-mainnamespacepagelink}}|дөйөм]] һәм [[{{int:visualeditor-usernamespacepagelink}}|шәхси]] исемдәр арауығында ғына)',
	...
	'visualeditor-wikitext-warning' => 'Һеҙ ҡулланған Күҙләгес мөхәррир - [[{{int:visualeditor-wikitext-warning-link}}|wikitext]] бында эшләмәй. Викитекст режимында мөхәррирләү өсөн "{{int:visualeditor-ca-editsource}}" төймәһенә баҫығыҙ – һаҡланмаған үҙгәртеүҙәр юғаласаҡ.',
 ...
 */
$messages['be'] = array(
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|Візуальны рэдактар]]', # Fuzzy
	'tag-visualeditor-description' => 'Праўка зроблена з выкарыстаннем [[{{int:Visualeditor-descriptionpagelink}}|візуальнага рэдактара]]', # Fuzzy
	...
	'visualeditor-preference-enable' => 'Уключыць VisualEditor (толькі ў [[{{int:Visualeditor-mainnamespacepagelink}}|асноўнай]] і [[{{int:Visualeditor-usernamespacepagelink}}|асабістай]] прасторах імёнаў).', # Fuzzy
...
$messages['be-tarask'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-description' => 'Праўка зробленая празь [[{{int:Visualeditor-descriptionpagelink}}|візуальны рэдактар]]', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor: Праверыць]]', # Fuzzy
	'tag-visualeditor-needcheck-description' => 'Праўка была зроблена [[{{int:Visualeditor-descriptionpagelink}}|візуальным рэдактарам]], і сыстэма заўважыла патэнцыйна непажаданыя зьмены ў вікітэксьце.', # Fuzzy
	...
	'visualeditor-beta-warning' => 'Візуальны рэдактар знаходзіцца ў «бэце», таму ня можа пакуль дазволіць вам рэдагаваць будзь-што.', # Fuzzy
	...
	'visualeditor-help-label' => 'Дапаможнік', # Fuzzy
	...
	'visualeditor-inspector-remove-tooltip' => 'Выдаліць',
	'visualeditor-languageinspector-block-tooltip' => 'Моўны блёк: $1$2',
	...
	'visualeditor-preference-enable' => 'Уключыць візуальны рэдактар (толькі ў [[{{int:Visualeditor-mainnamespacepagelink}}|асноўнай прасторы]] і [[{{int:Visualeditor-usernamespacepagelink}}|прасторы ўдзельнікаў]])', # Fuzzy
	...
	'visualeditor-wikitext-warning' => 'Вы карыстаецеся візуальным рэдактарам — [[{{int:Visualeditor-wikitext-warning-link}}|вікітэкст]] тут не працуе. Пстрыкніце «{{int:Visualeditor-ca-editsource}}», каб рэдагаваць старонку ў рэжыме вікітэксту (незахаваныя зьмены будуць страчаныя).', # Fuzzy
...
$messages['bn'] = array(
	...
	'tag-visualeditor' => '[[{{int:visualeditor-descriptionpagelink}}|ভিজ্যুয়ালএডিটর]]',
	'tag-visualeditor-description' => 'সম্পাদনাটি [[{{int:visualeditor-descriptionpagelink}}|ভিজ্যুয়ালএডিটর]] ব্যবহার করে করা হয়েছে',
	'tag-visualeditor-needcheck' => '[[{{int:visualeditor-descriptionpagelink}}|ভিজ্যুয়ালএডিটর: পরীক্ষা করুন]]',
	'tag-visualeditor-needcheck-description' => '[[{{int:visualeditor-descriptionpagelink}}|ভিজ্যুয়ালএডিটর]] ব্যবহার করে সম্পাদনা যেখানে সিস্টেম সনাক্ত করেছে উইকিটেক্সটে সম্ভাব্য অনিচ্ছাকৃত পরিবর্তন হচ্ছে।',
	...
	'visualeditor-languageinspector-block-tooltip' => 'ভাষা অবরোধ: $1$2',
	...
	'visualeditor-preference-enable' => 'ভিজ্যুয়ালএডিটর সক্রিয় করো (শুধুমাত্র [[{{int:visualeditor-mainnamespacepagelink}}|প্রধান]] এবং [[{{int:visualeditor-usernamespacepagelink}}|ব্যবহারকারী]] নামস্থানে)',
	...
	'visualeditor-wikitext-warning' => 'আপনি ভিজ্যুয়ালএডিটর ব্যবহার করছেন - এখানে [[{{int:visualeditor-wikitext-warning-link}}|উইকিটেক্সট]] কাজ করে না। উইকিটেক্সট মোডে পাতা সম্পাদনা করার জন্য "{{int:visualeditor-ca-editsource}}য়" ক্লিক করুন - আপনার অসংরক্ষিত পরিবর্তনগুলি হারিয়ে যাবে।',
 ...
 */
$messages['ca'] = array(
	'tag-visualeditor-description' => "Modificació feta amb l'[[{{int:Visualeditor-descriptionpagelink}}|editor visual]]", # Fuzzy
	...
	'visualeditor-preference-enable' => "Habilita l'editor visual (només en els espais de noms [[{{int:Visualeditor-mainnamespacepagelink}}|principal]] i d'[[{{int:Visualeditor-usernamespacepagelink}}|usuari]])", # Fuzzy
 ...
 */
$messages['ce'] = array(
	'tag-visualeditor' => '[[{{int:visualeditor-descriptionpagelink}}|Визуальни тадар]]',
	'tag-visualeditor-description' => '[[{{int:Visualeditor-descriptionpagelink}}|Визуальни тадарш]] дечунна гӀонца дина нисдарш', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|Визуальни тадарш дерг]]: хьажа', # Fuzzy
	'tag-visualeditor-needcheck-description' => '[[{{int:Visualeditor-descriptionpagelink}}|Визуальни тадарш дечун]] гӀонца дина нисдар, цунна чохь ситемин карина нийса боцу вики-йозан хийцамаш.', # Fuzzy
	...
	'visualeditor-preference-enable' => 'Лелае Визуальни тадар ([[{{int:visualeditor-mainnamespacepagelink}}|коьрта]] а [[{{int:visualeditor-usernamespacepagelink}}|шин]] цӀерийн меттигашках а)',
...
$messages['ckb'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|دەستکاریکەری دیداری]]', # Fuzzy
	'tag-visualeditor-description' => 'دەستکاری بە [[{{int:Visualeditor-descriptionpagelink}}|دەستکاریکەری دیداری]]', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|دەستکاریکەری دیداری: تاوتوێ]]', # Fuzzy
	...
	'visualeditor-preference-enable' => 'ڕێگە بدە بە دەستکاریکەری دیداری (تەنیا لە بۆشاییی ناوەکانی [[{{int:Visualeditor-mainnamespacepagelink}}|سەرەکی]] و [[{{int:Visualeditor-usernamespacepagelink}}|بەکارھێنەر]]دا)', # Fuzzy
...
$messages['cs'] = array(
	...
	'tag-visualeditor' => '[[{{int:visualeditor-descriptionpagelink}}|VisualEditor]]',
	'tag-visualeditor-description' => 'Editace provedená za použití [[{{int:visualeditor-descriptionpagelink}}|VisualEditoru]]',
	'tag-visualeditor-needcheck' => '[[{{int:visualeditor-descriptionpagelink}}|VisualEditor: Zkontrolovat]]',
	'tag-visualeditor-needcheck-description' => 'Editace provedená za použití [[{{int:visualeditor-descriptionpagelink}}|VisualEditoru]], u které systém detekoval možné nezamýšlené změny wikitextu.',
	...
	'visualeditor-preference-enable' => 'Povolit VisualEditor (pouze v [[{{int:visualeditor-mainnamespacepagelink}}|hlavním]] a [[{{int:visualeditor-usernamespacepagelink}}|uživatelském]] jmenném prostoru)',
	...
	'visualeditor-wikitext-warning' => 'Používáte VisualEditor – [[{{int:visualeditor-wikitext-warning-link}}|wikitext]] zde nefunguje. Kliknutím na „{{int:visualeditor-ca-editsource}}“ můžete stránku editovat v režimu wikitextu – neuložené změny budou ztraceny.',
...
$messages['cy'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|y Golygydd Gweledol]]', # Fuzzy
	'tag-visualeditor-description' => "Golygwyd gyda'r [[{{int:Visualeditor-descriptionpagelink}}|Golygydd Gweledol]]", # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|y Golygydd Gweledol:Angen gwirio]]', # Fuzzy
	'tag-visualeditor-needcheck-description' => "Golygwyd gyda'r [[{{int:Visualeditor-descriptionpagelink}}|Golygydd Gweledol]] pan adnabu'r sustem y gallai'r gystrawen wici arwain at newidiadau anfwriadol.", # Fuzzy
	...
	'visualeditor-preference-enable' => "Galluogi'r Golygydd Gweledol (dim ond yn y [[{{int:Visualeditor-mainnamespacepagelink}}|prif barth]] a [[{{int:Visualeditor-usernamespacepagelink}}|pharth y defnyddwyr]] y gallwch ei ddefnyddio)", # Fuzzy
...
$messages['da'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-description' => 'Redigeret ved hjælp af [[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor: Tjek]]', # Fuzzy
	'tag-visualeditor-needcheck-description' => 'Redigering foretaget ved hjælp af [[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]] hvor systemet har registreret at wikitexten muligvis har utilsigtede ændringer.', # Fuzzy
	...
	'visualeditor-preference-enable' => 'Aktiverer VisualEditor (kun i [[{{int:Visualeditor-mainnamespacepagelink}}|artikel]] og [[{{int:Visualeditor-usernamespacepagelink}}|bruger]] navneområderne)', # Fuzzy
	...
	'visualeditor-wikitext-warning' => 'Du bruger VisualEditor - [[{{int:Visualeditor-wikitext-warning-link}}|wikitext]] virker ikke her. Klik på "{{int:Visualeditor-ca-editsource}}"  for at redigere siden i wikitext tilstand – ændringer der ikke er gemt vil gå tabt.', # Fuzzy
	'visualeditor-wikitext-warning-link' => 'Help:Wikitext',
...
$messages['de'] = array(
	...
	'tag-visualeditor-needcheck' => '[[{{int:visualeditor-descriptionpagelink}}|VisualEditor: Überprüfung]]',
	'tag-visualeditor-needcheck-description' => 'Mit dem [[{{int:visualeditor-descriptionpagelink}}|VisualEditor]] vorgenommene Bearbeitung, bei der das System möglicherweise ungewollte Änderungen im Wikitext entdeckt hat.',
	...
	'visualeditor-preference-enable' => 'Aktiviere den VisualEditor (nur im [[{{int:visualeditor-mainnamespacepagelink}}|Artikel-]] und [[{{int:visualeditor-usernamespacepagelink}}|Benutzernamensraum]]; nur Firefox, Chrome und Safari)',
	...
	'visualeditor-wikitext-warning' => 'Du benutzt VisualEditor. [[{{int:visualeditor-wikitext-warning-link}}|Wikitext]] funktioniert hier nicht. Klicke auf „{{int:visualeditor-ca-editsource}}“, um die Seite im Wikitextmodus zu bearbeiten. Ungespeicherte Änderungen gehen dabei verloren.',
	'visualeditor-wikitext-warning-link' => 'Help:Wikitext',
...
$messages['dsb'] = array(
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-description' => 'Z pomocu [[{{int:Visualeditor-descriptionpagelink}}|VisualEditora]] wobźěłany', # Fuzzy
	...
	'visualeditor-preference-enable' => 'VisualEditor zmóžniś (jeno w [[{{int:Visualeditor-mainnamespacepagelink}}|głownem mjenjowem rumje]] a [[{{int:Visualeditor-usernamespacepagelink}}|wužywarskem mjenjowem rumje]])', # Fuzzy
...
$messages['el'] = array(
	...
	'tag-visualeditor' => '[[{{int:visualeditor-descriptionpagelink}}|VisualEditor]]',
	'tag-visualeditor-description' => 'Επεξεργασία που έγινε με τη χρήση του [[{{int:visualeditor-descriptionpagelink}}|VisualEditor]]',
	'tag-visualeditor-needcheck-description' => 'Επεξεργασία που έγινε μέσω του [[{{int:visualeditor-descriptionpagelink}}|VisualEditor]] όπου το σύστημα ανίχνευσε πιθανές μη ηθελημένες αλλαγές στον πηγαίο κώδικα.',
	...
	'visualeditor-preference-enable' => 'Ενεργοποίηση VisualEditor (μόνο για τους χώρους [[{{int:visualeditor-mainnamespacepagelink}}|κύριο]] και [[{{int:visualeditor-usernamespacepagelink}}|χρήστη]])',
	...
	'visualeditor-wikitext-warning' => 'Χρησιμοποιείτε τον VisualEditor - Ο [[{{int:visualeditor-wikitext-warning-link}}|wikitext]] δεν λειτουργεί εδώ.Πατήστε "{{int:visualeditor-ca-editsource}}" για να επεξεργαστείτε τη σελίδα με τον επεξεργαστή κώδικα (οι μη αποθηκευμένες αλλαγές θα χαθούν).',
...
$messages['eml'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|EditôrVisuèl]]', # Fuzzy
	'tag-visualeditor-description' => 'Mudificasiòun fàta druènd al [[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor: Da verifichèr]]', # Fuzzy
	'tag-visualeditor-needcheck-description' => "Mudificasiòun fàta druènd al [[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]], in dù al sistêma l' à catè ch' al wikitext fórsi al gh' à dal mudificasiòun mìa vlûdi.", # Fuzzy
	...
	'visualeditor-languageinspector-block-tooltip' => 'Blōc ed lìngui: $1$2',
	...
	'visualeditor-preference-enable' => 'Ativèr VisualEditor (sôl in dj spàsi [[{{int:Visualeditor-mainnamespacepagelink}}|prinsipèl]] e [[{{int:Visualeditor-usernamespacepagelink}}|utèint]])', # Fuzzy
	...
	'visualeditor-wikitext-warning' => 'A sî dré a druèr VisualEditor - Al [[{{int:Visualeditor-wikitext-warning-link}}|wikitext]] al ne funsiòuna brìsa chè. Andè a clichèr "{{int:Visualeditor-ca-editsource}}" per cambièr la pàgina in dla manéra wikitexte (j cambiamèint mìa salvè j andràn pèrs)', # Fuzzy
...
$messages['eo'] = array(
	...
	'visualeditor-preference-enable' => 'Ŝalti VidRedaktilon (nur en [[{{int:visualeditor-mainnamespacepagelink}}|ĉefa]] kaj [[{{int:visualeditor-usernamespacepagelink}}|poruzanta]] nomespacoj)',
...
$messages['es'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|Editor visual]]', # Fuzzy
	'tag-visualeditor-description' => 'Edición realizada con el [[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor: Comprobar]]', # Fuzzy
	'tag-visualeditor-needcheck-description' => 'Editar utilizando el [[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]] donde el sistema detecta wikitexto con posibles cambios no intencionados.', # Fuzzy
	...
	'visualeditor-languageinspector-block-tooltip' => 'Bloque de Idioma: $1$2',
	...
	'visualeditor-preference-enable' => 'Activar el editor visual (sólo en los espacios de nombres [[{{int:Visualeditor-mainnamespacepagelink}}|principal]]) y de [[{{int:Visualeditor-usernamespacepagelink}}|usuario]]', # Fuzzy
	...
	'visualeditor-wikitext-warning' => 'Usted está usando VisualEditor-[[{{int:Visualeditor-wikitext-warning-link}}|wikitexto]] no funciona aquí. Haga clic en "{{int:Visualeditor-ca-editsource}}" para editar la página en modo de wikitexto – los cambios no guardados se perderán.', # Fuzzy
...
$messages['et'] = array(
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-description' => 'Muudatus tehtud [[{{int:Visualeditor-descriptionpagelink}}|VisualEditoriga]]', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor: Kontrollida]]', # Fuzzy
	'tag-visualeditor-needcheck-description' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditoriga]] tehtud muudatus, mille tõttu võis vikitekst muutuda ettekavatsemata viisil.', # Fuzzy
	...
	'visualeditor-preference-enable' => 'Kasuta VisualEditori (ainult [[{{int:Visualeditor-mainnamespacepagelink}}|põhi]]- ja [[{{int:Visualeditor-usernamespacepagelink}}|kasutajanimeruumis]])', # Fuzzy
	...
	'visualeditor-wikitext-warning' => 'Kasutad VisualEditori. [[{{int:Visualeditor-wikitext-warning-link}}|Vikitekst]] siin ei tööta. Klõpsa "{{int:Visualeditor-ca-editsource}}", et redigeerida vikitekstirežiimis – salvestamata muudatused lähevad kaotsi.', # Fuzzy
...
$messages['fa'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|ویرایشگر دیداری]]', # Fuzzy
	'tag-visualeditor-description' => 'ویرایش انجام‌شده با [[{{int:Visualeditor-descriptionpagelink}}|ویرایشگر دیداری]]', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|ویرایشگر دیداری: وارسی]]', # Fuzzy
	'tag-visualeditor-needcheck-description' => 'ویرایش انجام‌شده با [[{{int:Visualeditor-descriptionpagelink}}|ویرایشگر دیداری]] که در آن سامانه احتمال وقوع تغییرات ناخواسته در ویکی‌متن را شناسایی کرد.', # Fuzzy
	...
	'visualeditor-preference-enable' => 'فعال‌سازی ویرایشگر دیداری (فقط در فضاهای نام [[{{int:Visualeditor-mainnamespacepagelink}}|اصلی]] و [[{{int:Visualeditor-usernamespacepagelink}}|کاربر]])', # Fuzzy
	...
	'visualeditor-wikitext-warning' => 'شما از ویرایشگر دیداری استفاده می‌کنید - [[{{int:Visualeditor-wikitext-warning-link}}|ویکی‌متن]] در اینجا عمل نخواهد کرد. بر روی  "{{int:Visualeditor-ca-editsource}}" کلیک کنید تا ویرایش در محیط ویکی‌متن انجام گیرد. (تغییرات ذخیره نشده از بین خواهند رفت).', # Fuzzy
	'visualeditor-wikitext-warning-link' => 'Help:Wiki markup',
...
$messages['fi'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|Visuaalinen muokkain]]', # Fuzzy
	'tag-visualeditor-description' => 'Muutos tehtiin [[{{int:Visualeditor-descriptionpagelink}}|visuaalisella muokkaimella]]', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|Visuaalinen muokkain: Tarkista]]', # Fuzzy
	'tag-visualeditor-needcheck-description' => '[[{{int:Visualeditor-descriptionpagelink}}|Visuaalisella muokkaimella]] tehty muokkaus, jossa järjestelmä havaitsi wikitekstissä mahdollisesti olevan tahattomia muutoksia.', # Fuzzy
	...
	'visualeditor-preference-enable' => 'Käytä visuaalista muokkainta (vain [[{{int:Visualeditor-mainnamespacepagelink}}|pää-]] ja [[{{int:Visualeditor-usernamespacepagelink}}|käyttäjä]]-nimiavaruuksissa)', # Fuzzy
	...
	'visualeditor-wikitext-warning' => 'Käytät Visuaalista muokkainta - [[{{int:Visualeditor-wikitext-warning-link}}|wikiteksti]] ei toimi täällä. Paina "{{int:Visualeditor-ca-editsource}}" muokataksesi sivua wikiteksti-tilassa – tallentamattomat muokkaukset katoavat.', # Fuzzy
...
$messages['fr'] = array(
	...
	'tag-visualeditor' => '[[{{int:visualeditor-descriptionpagelink}}|VisualEditor]]',
	'tag-visualeditor-description' => 'Modification effectuée au moyen de [[{{int:visualeditor-descriptionpagelink}}|VisualEditor]]',
	'tag-visualeditor-needcheck' => '[[{{int:visualeditor-descriptionpagelink}}|VisualEditor : À vérifier]]',
	'tag-visualeditor-needcheck-description' => 'Modification faite en utilisant [[{{int:visualeditor-descriptionpagelink}}|VisualEditor]], où le système a détecté que le wikitexte contient peut-être des modifications accidentelles.',
	...
	'visualeditor-preference-enable' => 'Activer l’ÉditeurVisuel (seulement dans les espaces de noms [[{{int:visualeditor-mainnamespacepagelink}}|principal]] et [[{{int:visualeditor-usernamespacepagelink}}|utilisateur]])',
	...
	'visualeditor-wikitext-warning' => 'Vous utilisez VisualEditor — Le [[{{int:visualeditor-wikitext-warning-link}}|wikitexte]] ne fonctionne pas ici. Cliquez sur « {{int:visualeditor-ca-editsource}} » pour modifier la page en mode wikitexte — les modifications non sauvegardées seront perdues.',
...
$messages['gl'] = array(
	...
	'tag-visualeditor' => '[[{{int:visualeditor-descriptionpagelink}}|Editor visual]]',
	'tag-visualeditor-description' => 'Edición feita mediante o [[{{int:visualeditor-descriptionpagelink}}|editor visual]]',
	'tag-visualeditor-needcheck' => '[[{{int:visualeditor-descriptionpagelink}}|Editor visual: Comprobar]]',
	'tag-visualeditor-needcheck-description' => 'Edición feita mediante o [[{{int:visualeditor-descriptionpagelink}}|editor visual]] na que o sistema detectou que o texto wiki posiblemente teña modificacións non intencionadas.',
	...
	'visualeditor-preference-enable' => 'Activar o editor visual (só nos espazos de nomes [[{{int:visualeditor-mainnamespacepagelink}}|principal]] e de [[{{int:visualeditor-usernamespacepagelink}}|usuario]])',
	...
	'visualeditor-wikitext-warning' => 'Está usando o editor visual; o [[{{int:visualeditor-wikitext-warning-link}}|texto wiki]] non funciona aquí. Prema en "{{int:visualeditor-ca-editsource}}" para editar a páxina no modo de texto wiki (os cambios non gardados vanse perder).',
...
$messages['he'] = array(
	...
	'tag-visualeditor' => '[[{{int:visualeditor-descriptionpagelink}}|העורך החזותי]]',
	'tag-visualeditor-description' => 'העריכה נעשתה באמצעות [[{{int:visualeditor-descriptionpagelink}}|העורך החזותי]]',
	'tag-visualeditor-needcheck' => '[[{{int:visualeditor-descriptionpagelink}}|עורך חזותי: נא לבדוק]]',
	'tag-visualeditor-needcheck-description' => 'עריכה שנעשתה באמצעות [[{{int:visualeditor-descriptionpagelink}}|העורך החזותי]] ושהמערכת זיהתה שבקוד שלה אולי יש שינויים שלא היו אמורים להיעשות.',
	...
	'visualeditor-preference-enable' => 'הפעלת העורך החזותי (רק ב[[{{int:visualeditor-mainnamespacepagelink}}|מרחב הראשי]] וב[[{{int:visualeditor-usernamespacepagelink}}|מרחב המשתמש]])',
	...
	'visualeditor-wikitext-warning' => 'זהו עורך חזותי – [[{{int:visualeditor-wikitext-warning-link}}|קוד ויקי]] לא יעבוד כאן. יש ללחוץ "{{int:visualeditor-ca-editsource}}" כדי לערוך את הדף במצב קוד ויקי – שינויים שלא נשמרו יאבדו.',
	'visualeditor-wikitext-warning-link' => 'Help:Wiki markup',
...
$messages['hi'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|विज़ुअल एडिटर]]', # Fuzzy
	'tag-visualeditor-description' => '[[{{int:Visualeditor-descriptionpagelink}}|विज़ुअल एडिटर]] के प्रयोग से किया सम्पादन', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|विज़ुअल एडिटर: जाँच आवश्यक]]', # Fuzzy
	'tag-visualeditor-needcheck-description' => '[[{{int:Visualeditor-descriptionpagelink}}|विज़ुअल एडिटर]] के प्रयोग से किये गए सम्पादन जिनमे सिस्टम ने पाया है कि विकिपाठ में अनापेक्षित बदलाव हो सकते हैं।', # Fuzzy
	...
	'visualeditor-preference-enable' => 'विज़ुअल एडिटर सक्षम करें (केवल [[{{int:Visualeditor-mainnamespacepagelink}}|मुख्य]] एवं [[{{int:Visualeditor-usernamespacepagelink}}|सदस्य]] नामस्थानों में)', # Fuzzy
...
$messages['hsb'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-description' => 'Z pomocu [[{{int:Visualeditor-descriptionpagelink}}|VisualEditora]] wobdźěłany', # Fuzzy
	...
	'visualeditor-preference-enable' => 'VisualEditor zmóžnić (jenož we [[{{int:Visualeditor-mainnamespacepagelink}}|hłownym mjenowym rumje]] a [[{{int:Visualeditor-usernamespacepagelink}}|wužiwarskim mjenowym rumje]])', # Fuzzy
...
$messages['hu'] = array(
	...
	'tag-visualeditor-description' => 'A szerkesztéshez használt segédeszköz a  [[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]] volt.', # Fuzzy
	'visualeditor' => 'VisualEditor',
...
$messages['id'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-description' => 'Suntingan menggunakan [[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor: Periksa]]', # Fuzzy
	'tag-visualeditor-needcheck-description' => 'Suntingan menggunakan [[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]] dimana sistem mendeteksi wikitext mungkin mengalami perubahan yang tidak diinginkan.', # Fuzzy
	...
	'visualeditor-beta-label' => 'beta',
	'visualeditor-beta-warning' => 'VisualEditor masih dalam kondisi \'beta\'. Anda mungkin menjuumpai masalah, dan mungkin tidak dapat menyunting bagian halaman. Klik "Sunting sumber" untuk beralih ke mode penyntingan klasik (standar) - perubahan yang belum disimpan akan hilang.', # Fuzzy
	...
	'visualeditor-help-label' => 'Panduan',
	...
	'visualeditor-preference-enable' => 'Aktifkan VisualEditor (hanya pada ruang nama [[{{int:Visualeditor-mainnamespacepagelink}}|utama]] dan [[{{int:Visualeditor-usernamespacepagelink}}|pengguna]])', # Fuzzy
	...
	'visualeditor-wikitext-warning' => 'Anda menggunakan VisualEditor - [[{{int:Visualeditor-wikitext-warning-link}}|teks wiki]] tidak bekerja di sini. Klik "{{int:Visualeditor-ca-editsource}}" untuk menyunting halaman dalam mode teks wiki (perubahan yang belum disimpan akan hilang).', # Fuzzy
...
$messages['ilo'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-description' => 'Inurnos nga inusar ti [[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor: Kitaen]]', # Fuzzy
	'tag-visualeditor-needcheck-description' => 'Ti urnos nga inaramid nga inusar ti [[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]] a ti sistema ket nakaduktal ti wikitext nga adda kadagiti mabalin a saan a naikeddeng a panagbalbaliw.', # Fuzzy
	...
	'visualeditor-languageinspector-block-tooltip' => 'Muton ti Pagsasao:$1$2',
	...
	'visualeditor-preference-enable' => 'Pakabaelan ti VisualEditor (iti laeng [[{{int:Visualeditor-mainnamespacepagelink}}|umuna]] ken [[{{int:Visualeditor-usernamespacepagelink}}|agar-aramat]] a nagnagan ti lugar)', # Fuzzy
	...
	'visualeditor-wikitext-warning' => 'Agus-usarka ti VisualEditor - ti [[{{int:Visualeditor-wikitext-warning-link}}| wikitext]] ket saan a mabalin ditoy. Pindutem ti "{{int:Visualeditor-ca-editsource}}" tapno maurnosmo ti panid iti moda ti wikitext – dagiti saan a naidulin a panagbalbaliw ket mapukawto.', # Fuzzy
...
$messages['is'] = array(
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-description' => 'Breyting gerð með hjálp [[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	...
	'visualeditor-preference-enable' => 'Virkja Visual Editor (eingöngu í [[{{int:Visualeditor-mainnamespacepagelink}}|aðal]] og [[{{int:Visualeditor-usernamespacepagelink}}|notenda]] nafnarýmunum)', # Fuzzy
...
$messages['it'] = array(
	...
	'tag-visualeditor-needcheck' => '[[{{int:visualeditor-descriptionpagelink}}|VisualEditor: controllare]]',
	'tag-visualeditor-needcheck-description' => 'Modifica eseguita utilizzando [[{{int:visualeditor-descriptionpagelink}}|VisualEditor]] dove il sistema ha rilevato possibili modifiche non volute nel wikitesto.',
	...
	'visualeditor-preference-enable' => 'Abilita VisualEditor (solo nei namespace [[{{int:visualeditor-mainnamespacepagelink}}|principale]] e [[{{int:visualeditor-usernamespacepagelink}}|Utente]])',
	...
	'visualeditor-wikitext-warning' => 'Stai usando VisualEditor - il [[{{int:visualeditor-wikitext-warning-link}}|wikitesto]] non funziona qui. Clicca "{{int:visualeditor-ca-editsource}}" per modificare la pagina usando wikitesto (le modifiche non salvate andranno perse).',
...
$messages['ja'] = array(
	...
	'tag-visualeditor' => '[[{{int:visualeditor-descriptionpagelink}}|ビジュアルエディター]]',
	'tag-visualeditor-description' => '[[{{int:visualeditor-descriptionpagelink}}|ビジュアルエディター]]を使用した編集',
	'tag-visualeditor-needcheck' => '[[{{int:visualeditor-descriptionpagelink}}|ビジュアルエディター: 要確認]]',
	'tag-visualeditor-needcheck-description' => '[[{{int:visualeditor-descriptionpagelink}}|ビジュアルエディタ―]]を使用した編集のうち、意図しない変更点を含むおそれがあるとシステムが判断したもの',
	...
	'visualeditor-preference-enable' => 'ビジュアルエディターを有効にする ([[{{int:visualeditor-mainnamespacepagelink}}|標準名前空間]]および[[{{int:visualeditor-usernamespacepagelink}}|利用者名前空間]]のみ)',
	...
	'visualeditor-wikitext-warning' => 'ビジュアルエディターをご使用中です。[[{{int:visualeditor-wikitext-warning-link}}|ウィキテキスト]]はここでは使用できません。ウィキテキスト モードでページを編集するには、「{{int:visualeditor-ca-editsource}}」をクリックしてください。クリックすると、未保存の編集内容は失われます。',
...
$messages['ka'] = array(
	...
	'tag-visualeditor' => '[[{{int:visualeditor-descriptionpagelink}}|ვიზუალური რედაქტორი]]',
	'tag-visualeditor-description' => 'რედაქტირება შესრულებულია [[{{int:visualeditor-descriptionpagelink}}|ვიზუალური რედაქტორის]] საშუალებით',
	'tag-visualeditor-needcheck' => '[[{{int:visualeditor-descriptionpagelink}}|ვიზუალური რედაქტორი: შემოწმება]]',
	'tag-visualeditor-needcheck-description' => 'რედაქტირება შესრულებულია [[{{int:visualeditor-descriptionpagelink}}|ვიზუალური რედაქტორის]] საშუალებით, რომელშიც სისტემამ აღმოაჩინა, შესაძლოა, უნებლიედ შეცვლილი ვიკი-ტექსტი.',
	...
	'visualeditor-languageinspector-block-tooltip' => 'ენის ბლოკი: $1$2',
	...
	'visualeditor-preference-enable' => 'ვიზუალური რედაქტორის ჩართვა (მხოლოდ [[{{int:visualeditor-mainnamespacepagelink}}|მთავარ]] და [[{{int:visualeditor-usernamespacepagelink}}|მომხმარებლის]] სახელთა სივრცეში)',
...
$messages['kk-cyrl'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-description' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]] қолданылып жасаған өңдеме.', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor: Тексеру]]', # Fuzzy
	...
	'visualeditor-preference-enable' => '[[УП:VE|VisualEditor‎]]-ды қосу (тек [[{{int:Visualeditor-mainnamespacepagelink}}|негізгі]] және [[{{int:Visualeditor-usernamespacepagelink}}|қатысушы]] есім кеңістігінде)', # Fuzzy
...
$messages['ko'] = array(
	...
	'tag-visualeditor' => '[[{{int:visualeditor-descriptionpagelink}}|시각편집기]]',
	'tag-visualeditor-description' => '[[{{int:visualeditor-descriptionpagelink}}|시각편집기]]를 사용한 편집',
	'tag-visualeditor-needcheck' => '[[{{int:visualeditor-descriptionpagelink}}|시각편집기: 확인 필요]]',
	'tag-visualeditor-needcheck-description' => '[[{{int:visualeditor-descriptionpagelink}}|시각편집기]]를 사용해 편집하는 동안 의도하지 않은 바뀜을 갖는 위키텍스트를 시스템이 발견했습니다.',
	...
	'visualeditor-languageinspector-block-tooltip' => '언어 블록: $1$2',
	...
	'visualeditor-preference-enable' => '시각편집기 활성화 ([[{{int:visualeditor-mainnamespacepagelink}}|표준]] 및 [[{{int:visualeditor-usernamespacepagelink}}|사용자]] 이름공간에서만)',
	...
	'visualeditor-wikitext-warning' => '시각편집기를 사용하고 있으며 [[{{int:visualeditor-wikitext-warning-link}}|위키텍스트]]는 여기서 작동하지 않습니다. 위키텍스트 모드로 문서를 편집하려면 "{{int:visualeditor-ca-editsource}}"을 클릭하세요 – 저장하지 않은 바뀜은 사라집니다.',
 ...
 */
$messages['krc'] = array(
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|Визуал редактор]]', # Fuzzy
	'tag-visualeditor-description' => 'Тюрлендириу, [[{{int:Visualeditor-descriptionpagelink}}|визуал редактор]] бла этилгенди', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|Визуал редактор]]: тинт', # Fuzzy
	'tag-visualeditor-needcheck-description' => 'Система, иш этиб тюрлендирилмеген вики-текст табхан, [[{{int:Visualeditor-descriptionpagelink}}|визуал редакторну]] болушлугъу бла этилген тюрлендириу.', # Fuzzy
...
$messages['lb'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-description' => 'Ännerung mam [[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]] gemaach', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor: Kontroll]]', # Fuzzy
	...
	'visualeditor-annotationbutton-link-tooltip' => 'Link',
	'visualeditor-beta-label' => 'beta',
	'visualeditor-beta-warning' => 'VisualEditor ass eng \'beta\'-Versioun. Dir kéint Software-Problemer begéinen an Dir kënnt vläicht net all Deeler vun der Säit änneren.

Klickt "Quelltext änneren" fir op Wikitext-Modus ze wieselen - dobäi ginn déi net gespäichert Ännerunge verluer.', # Fuzzy
	...
	'visualeditor-help-label' => 'Liest de Benotzer-Guide',
	...
	'visualeditor-languageinspector-block-tooltip' => 'Spär vun de Sproochen:$1$2',
	'visualeditor-languageinspector-block-tooltip-rtldirection' => ': Riets no Lénks',
...
$messages['min'] = array(
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-description' => 'Suntiangan manggunoan [[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	...
	'visualeditor-preference-enable' => 'Aktipan VisualEditor (hanyo pado ruangnamo [[{{int:Visualeditor-mainnamespacepagelink}}|utamo]] jo [[{{int:Visualeditor-usernamespacepagelink}}|pangguno]])', # Fuzzy
...
$messages['mk'] = array(
	...
	'tag-visualeditor' => '[[{{int:visualeditor-descriptionpagelink}}|ВизуеленУредник]]',
	'tag-visualeditor-description' => 'Уредувањето е направено со [[{{int:visualeditor-descriptionpagelink}}|ВизуеленУредник]]',
	'tag-visualeditor-needcheck' => '[[{{int:visualeditor-descriptionpagelink}}|ВизуеленУредник: Проверка]]',
	'tag-visualeditor-needcheck-description' => 'Уредување направено со [[{{int:visualeditor-descriptionpagelink}}|ВизуеленУредник]] при кое системот утврдил дека викитекстот може да има ненамерни измени.',
	...
	'visualeditor-preference-enable' => 'Овозможи ВизуеленУредник (само во [[{{int:visualeditor-mainnamespacepagelink}}|главниот]] и [[{{int:visualeditor-usernamespacepagelink}}|корисничкиот]] именски простор)',
	...
	'visualeditor-wikitext-warning' => 'Користите ВизуеленУредник — тука не работи [[{{int:visualeditor-wikitext-warning-link}}|викитекст]]. Стиснете на „{{int:visualeditor-ca-editsource}}“ за да ја уредите страницава во режим со викитекст — ако не ги зачувате, измените ќе се изгубат.',
...
$messages['ml'] = array(
	...
	'tag-visualeditor' => '[[{{int:visualeditor-descriptionpagelink}}|കണ്ടുതിരുത്തൽസൗകര്യം]]',
	'tag-visualeditor-description' => '[[{{int:visualeditor-descriptionpagelink}}|കണ്ടുതിരുത്തൽ സൗകര്യമുപയോഗിച്ച്]] നടത്തിയ തിരുത്തൽ',
	'tag-visualeditor-needcheck' => '[[{{int:visualeditor-descriptionpagelink}|കണ്ടുതിരുത്തൽസൗകര്യം: പരിശോധിക്കുക]]', # Fuzzy
	'tag-visualeditor-needcheck-description' => '[[{{int:visualeditor-descriptionpagelink}}|കണ്ടുതിരുത്തൽ സൗകര്യം]] ഉപയോഗിച്ച് തിരുത്തുമ്പോൾ വിക്കി എഴുത്ത് ഉൾപ്പെട്ടാൽ അപ്രതീക്ഷിത മാറ്റങ്ങൾ ഉണ്ടായേക്കാനിടയുണ്ട്.',
	...
	'visualeditor-languageinspector-block-tooltip' => 'ഭാഷാഖണ്ഡം: $1$2',
	...
	'visualeditor-preference-enable' => 'കണ്ടുതിരുത്തൽ സൗകര്യം സജ്ജമാക്കുക ([{{int:visualeditor-mainnamespacepagelink}}|പ്രധാന നാമമേഖലയിലും]] [[{{int:visualeditor-usernamespacepagelink}}|ഉപയോക്തൃനാമമേഖലയിലും]] മാത്രം)', # Fuzzy
	...
	'visualeditor-wikitext-warning' => 'താങ്കൾ കണ്ടുതിരുത്തൽ സൗകര്യമാണ് ഉപയോഗിക്കുന്നത്; ദയവായി [[{{int:Visualeditor-wikitext-warning-link}}|വിക്കി എഴുത്തുകൾ]] ചേർക്കാതിരിക്കുക, അവ പ്രവർത്തിക്കുകയില്ല.', # Fuzzy
...
$messages['mr'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|यथादृश्यसंपादक]]', # Fuzzy
	'tag-visualeditor-description' => '[[{{int:Visualeditor-descriptionpagelink}}|यथादृश्यसंपादक]] वापरून केलेले संपादन', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|यथादृश्यसंपादक: तपासा]]', # Fuzzy
	'tag-visualeditor-needcheck-description' => '[[{{int:Visualeditor-descriptionpagelink}}|यथादृश्यसंपादक]] वापरून केलेल्या संपादनात,अभिप्रेत नसलेला विकिटेक्स्ट दिसल्याचे, प्रणालीने सूचीत केले आहे.', # Fuzzy
	...
	'visualeditor-preference-enable' => 'यथादृश्यसंपादक कार्यान्वित करा (केवळ [[{{int:Visualeditor-mainnamespacepagelink}}|मुख्य(लेख)]] आणि [[{{int:Visualeditor-usernamespacepagelink}}|सदस्य]] नामविश्वात)', # Fuzzy
	...
	'visualeditor-wikitext-warning' => 'आपण यथादृश्यसंपादक वापरत आहात - येथे [[{{int:Visualeditor-wikitext-warning-link}}|विकिविन्यास]] काम करत नाही.  संपन्नसंपादन पद्धतीने लेखपान संपादीत करण्यासाठी,येथे  "{{int:Visualeditor-ca-editsource}}" टिचकी मारा – आपले सध्याचे जतन न केलेले बदल हरवतील.', # Fuzzy
...
$messages['ms'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-description' => 'Disunting dengan menggunakan [[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor:Semak]]', # Fuzzy
	'tag-visualeditor-needcheck-description' => 'Suntingan dilakukan dengan menggunakan [[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]] di mana sistem telah mengesan wikiteks yang mungkin mengalami perubahan yang tidak diingini.', # Fuzzy
	...
	'visualeditor-preference-enable' => 'Hidupkan VisualEditor (hanya di ruang nama [[{{int:Visualeditor-mainnamespacepagelink}}|utama]] dan [[{{int:Visualeditor-usernamespacepagelink}}|pengguna]])', # Fuzzy
	...
	'visualeditor-wikitext-warning' => 'Anda sedang menggunakan VisualEditor – [[{{int:Visualeditor-wikitext-warning-link}}|wikiteks]] tidak akan berkesan di sini. Klik "{{int:Visualeditor-ca-editsource}}" untuk beralih ke mod wikiteks – sebarang suntingan yang belum disimpan akan disingkirkan.', # Fuzzy
...
$messages['nap'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-description' => 'Càgnamiento fatto ausando [[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor: cuntrolla]]', # Fuzzy
	...
	'visualeditor-usernamespacepagelink' => 'Project:Namespace utente',
	'visualeditor-wikitext-warning' => "Si ausando VisualEditor - 'o [[{{int:Visualeditor-wikitext-warning-link}}|wikitesto]] nun funzziona ccà. Clicca \"{{int:Visualeditor-ca-editsource}}\" ppe càgna 'a paggena ausando wikitesto ('e càgnamiente nun sarvate andranno perse).", # Fuzzy
	'visualeditor-wikitext-warning-link' => 'Help:Markup',
	'visualeditor-wikitext-warning-title' => 'Rilevato wikitesto',
...
$messages['nb'] = array(
	...
	'tag-visualeditor-needcheck' => '[[{{int:visualeditor-descriptionpagelink}}|VisualEditor: Sjekk]]',
	'tag-visualeditor-needcheck-description' => 'Redigering gjort med [[{{int:visualeditor-descriptionpagelink}}|VisualEditor]] med mulige utilsiktede endringer i wikiteksten.',
	...
	'visualeditor-inspector-remove-tooltip' => 'Fjern',
	'visualeditor-languageinspector-block-tooltip' => 'Språkblokk: $1$2',
	...
	'visualeditor-preference-enable' => 'Aktiver VisualEditor (kun i [[{{int:visualeditor-mainnamespacepagelink}}|hoved-]] og [[{{int:visualeditor-usernamespacepagelink}}|bruker]]-navnerommene)',
	...
	'visualeditor-wikitext-warning' => 'Du bruker VisualEditor - [[{{int:visualeditor-wikitext-warning-link}}|wikitekst]] virker ikke her. Trykk på «{{int:visualeditor-ca-editsource}}» for å redigere siden i wikitekst-modus – men merk at ulagrede endringer vil gå tapt.',
...
$messages['nds-nl'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|Visuele tekstverwarker]]', # Fuzzy
	'tag-visualeditor-description' => 'Bewarking emaakt mit behulp van de [[{{int:Visualeditor-descriptionpagelink}}|Visuele tekstverwarker]]', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:visualeditor-descriptionpagelink}}|Visuele tekstverwarker: naokieken]]',
	'tag-visualeditor-needcheck-description' => 'Bewarking edaon mit de [[{{int:visualeditor-descriptionpagelink}}|visuele tekstverwarker]] waorbie t systeem op-emörken hef dat der in de wikitekste meugelik onbedoelde wiezigingen esleupen bin.',
	...
	'visualeditor-languageinspector-block-tooltip' => 'Taalblokke: $1$2',
	...
	'visualeditor-preference-enable' => 'Visuele tekstverwarker anzetten (allinnig veur de [[{{int:visualeditor-mainnamespacepagelink}}|heufdnaamruumte]] en de [[{{int:visualeditor-usernamespacepagelink}}|gebrukersnaamruumte]])',
	...
	'visualeditor-wikitext-warning' => 'Je gebruken de visuele tekstverwarker - [[{{int:visualeditor-wikitext-warning-link}}|wikitekste]] warkt hier niet. Klik op "{{int:visualeditor-ca-editsource}}" um naor de modus wikitekste te gaon – wiezigingen die niet op-esleugen bin bi\'j kwiet.',
...
$messages['nl'] = array(
	...
	'tag-visualeditor' => '[[{{int:visualeditor-descriptionpagelink}}|Visuele tekstverwerker]]',
	'tag-visualeditor-description' => 'Bewerking gemaakt met behulp van de [[{{int:visualeditor-descriptionpagelink}}|Visuele tekstverwerker]]',
	'tag-visualeditor-needcheck' => '[[{{int:visualeditor-descriptionpagelink}}|Visuele tekstverwerker: controleer]]',
	'tag-visualeditor-needcheck-description' => 'Bewerking gemaakt met de [[{{int:visualeditor-descriptionpagelink}}|visuele tekstverwerker]] waarbij het systeem gedetecteerd heeft dat de wikitekst mogelijk onbedoelde veranderingen bevat.',
	...
	'visualeditor-aliennode-tooltip' => 'Helaas kan dit element voorlopig alleen in de broncode bewerkt worden.',
	'visualeditor-annotationbutton-bold-tooltip' => 'Vet',
	'visualeditor-annotationbutton-italic-tooltip' => 'Cursief',
	'visualeditor-annotationbutton-link-tooltip' => 'Koppeling',
	'visualeditor-beta-label' => 'beta',
	'visualeditor-beta-warning' => 'De visuele tekstverwerker is in \'beta\'. Het kan zijn dat u tegen softwareproblemen aanloopt, of dat u niet alles op de pagina kunt bewerken. Klik op "{{int:visualeditor-ca-editsource}}" om naar wikitekstmodus te gaan – veranderingen die niet zijn opgeslagen gaan dan verloren.',
	...
	'visualeditor-dialog-action-goback' => 'Ga terug',
	...
	'visualeditor-dialog-meta-languages-readonlynote' => "Dit is een lijst met pagina's in andere talen die gekoppeld zijn aan deze. Voorlopig kan deze lijst alleen in de broncode bewerkt worden.",
	'visualeditor-dialog-meta-languages-section' => 'Talen',
	...
	'visualeditor-dialog-reference-useexisting-label' => 'Gebruik een bestaande referentie',
	...
	'visualeditor-parameter-search-no-unused' => 'Geen ongebruikte parameters',
	'visualeditor-parameter-search-unknown' => 'Onbekende parameter',
	'visualeditor-preference-betatempdisable' => 'Schakel de visuele tekstverwerker tijdelijk uit terwijl deze in beta is',
	'visualeditor-preference-enable' => 'Visuele tekstverwerker inschakelen (alleen voor de [[{{int:visualeditor-mainnamespacepagelink}}|hoofdnaamruimte]] en de [[{{int:visualeditor-usernamespacepagelink}}|gebruikersnaamruimte]])',
	...
	'visualeditor-referencelist-missingref' => 'Deze referentie bevindt zich in een sjabloon of een ander soort gegenereerd blok, en kan voorlopig alleen in de broncode bewerkt worden.',
	'visualeditor-savedialog-error-badtoken' => 'Uw bewerking kon niet verwerkt worden omdat uw sessie niet meer geldig was.',
	'visualeditor-savedialog-identify-anon' => 'Wilt u deze pagina als een anonieme gebruiker opslaan? Uw IP-adres wordt dan opgeslagen in de paginageschiedenis.',
	'visualeditor-savedialog-identify-user' => 'U bent nu ingelogd als [[User:$1|$1]]. Deze bewerking zal aan deze gebruiker worden gekoppeld als u hem opslaat.',
	...
	'visualeditor-wikitext-warning' => 'U bevindt zich in de visuele tekstverwerker - [[{{int:visualeditor-wikitext-warning-link}}|wikitekst]] werkt hier niet. Klik op "{{int:visualeditor-ca-editsource}}" om naar wikitekstmodus te gaan – veranderingen die niet zijn opgeslagen gaan dan verloren.',
	'visualeditor-wikitext-warning-link' => 'Help:Tekstopmaak',
	'visualeditor-wikitext-warning-title' => 'Wikitekstopmaak gedetecteerd',
...
$messages['or'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|ଭିଜୁଆଲ ଏଡ଼ିଟର]]', # Fuzzy
...
$messages['pl'] = array(
	...
	'tag-visualeditor-needcheck' => '[[{{int:visualeditor-descriptionpagelink}}|VisualEditor: do sprawdzenia]]',
	'tag-visualeditor-needcheck-description' => 'Edycja z wykorzystaniem [[{{int:visualeditor-descriptionpagelink}}|VisualEditora]], w której system wykrył prawdopodobnie niezamierzone uszkodzenie wikikodu.',
	...
	'visualeditor-languageinspector-block-tooltip' => 'Blok językowy: $1$2',
	...
	'visualeditor-preference-enable' => 'Uaktywnij VisualEditor (tylko w [[{{int:visualeditor-mainnamespacepagelink}}|przestrzeni głównej]] i w [[{{int:visualeditor-usernamespacepagelink}}|przestrzeni użytkownika]])',
	...
	'visualeditor-wikitext-warning' => 'Używasz teraz VisualEditora –  [[{{int:visualeditor-wikitext-warning-link}}|znaczniki wikikodu]] tu nie działają. Kliknij „{{int:visualeditor-ca-editsource}}” żeby zacząć edytować tę stronę w trybie kodu wiki – niezapisane zmiany zostaną utracone.',
	'visualeditor-wikitext-warning-link' => 'Help:Wikitekst',
...
$messages['pms'] = array(
	...
	'tag-visualeditor' => '[[{{int:visualeditor-descriptionpagelink}}|Editor visual]]',
	'tag-visualeditor-description' => "Modìfica fàita dovrand l'[[{{int:visualeditor-descriptionpagelink}}|Editor visual]]",
	'tag-visualeditor-needcheck' => '[[{{int:visualeditor-descriptionpagelink}}|Editor visual: Da verifiché]]',
	'tag-visualeditor-needcheck-description' => "Modìfica fàita an dovrand [[{{int:visualeditor-descriptionpagelink}}|VisualEditor]] andoa ël sistema a l'ha trovà che miraco ël wikitest a conten dle modìfiche nen vorsùe.",
	...
	'visualeditor-preference-enable' => "Abilité l'Editor visual (mach ant jë spassi nominaj [[{{int:visualeditor-mainnamespacepagelink}}|prinsipal]] e [[{{int:visualeditor-usernamespacepagelink}}|utent]])",
...
$messages['pt'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|Editor Visual]]', # Fuzzy
	'tag-visualeditor-description' => 'Edição realizada utilizando o [[{{int:Visualeditor-descriptionpagelink}}|Editor Visual]]', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|Editor Visual: Verificar]]', # Fuzzy
	'tag-visualeditor-needcheck-description' => 'Edição feita com o [[{{int:Visualeditor-descriptionpagelink}}|Editor Visual]] em que o sistema detectou que o código wiki possivelmente teve alterações não intencionais.', # Fuzzy
	...
	'visualeditor-preference-enable' => 'Ativar Editor Visual (apenas nos domínios [[{{int:Visualeditor-mainnamespacepagelink}}|principal]] e [[{{int:Visualeditor-usernamespacepagelink}}|utilizador]])', # Fuzzy
	...
	'visualeditor-wikitext-warning' => 'Você está utilizando o Editor Visual - [[{{int:Visualeditor-wikitext-warning-link}}|código wiki]] não funciona aqui. Clique "{{int:Visualeditor-ca-editsource}}" para editar a página no modo de código wiki – alterações não salvas serão perdidas.', # Fuzzy
...
$messages['pt-br'] = array(
	...
	'tag-visualeditor' => '[[{{int:visualeditor-descriptionpagelink}}|Editor Visual]]',
	'tag-visualeditor-description' => 'Edição realizada utilizando o [[{{int:visualeditor-descriptionpagelink}}|Editor Visual]]',
	'tag-visualeditor-needcheck' => '[[{{int:visualeditor-descriptionpagelink}}|Editor Visual: Verificar]]',
	'tag-visualeditor-needcheck-description' => 'Edição realizada com o [[{{int:visualeditor-descriptionpagelink}}|Editor Visual]] em que o sistema detectou que o wikitexto possivelmente possui mudanças não planejadas.',
	'tooltip-ca-createsource' => 'Criar o código fonte desta página',
	'tooltip-ca-editsource' => 'Editar o código fonte desta página',
	...
	'visualeditor-inspector-close-tooltip' => 'Fechar',
	'visualeditor-inspector-remove-tooltip' => 'Remover',
	'visualeditor-languageinspector-block-tooltip' => 'Bloco de Idioma: $1$2',
	...
	'visualeditor-preference-enable' => 'Ativar o Editor Visual (apenas nos espaços nominais [[{{int:visualeditor-mainnamespacepagelink}}|principal]] e de [[{{int:visualeditor-usernamespacepagelink}}|usuário]])',
	...
	'visualeditor-viewpage-savewarning' => 'Tem certeza que deseja voltar para a página sem querer salvar a edição?',
	'visualeditor-wikitext-warning' => 'Você está utilizando o Editor Visual - [[{{int:visualeditor-wikitext-warning-link}}|código wiki]] não funciona aqui. Clique "{{int:visualeditor-ca-editsource}}" para editar a página no modo de código wiki – alterações não salvas serão perdidas.',
	'visualeditor-wikitext-warning-link' => 'Help:Marcação wiki',
	'visualeditor-wikitext-warning-title' => 'Código de wikitexto detectado',
	'visualeditor-window-title' => 'Inspecionar',
);
...
$messages['ro'] = array(
	...
	'tag-visualeditor' => '[[{{int:visualeditor-descriptionpagelink}}|EditorVizual]]',
	'tag-visualeditor-description' => 'Modificare efectuată cu [[{{int:visualeditor-descriptionpagelink}}|EditorulVizual]]',
	'tag-visualeditor-needcheck' => '[[{{int:visualeditor-descriptionpagelink}}|EditorVizual: Verificare]]',
	'tag-visualeditor-needcheck-description' => 'Modificare efectuată cu [[{{int:visualeditor-descriptionpagelink}}|EditorulVizual]], unde sistemul a detectat că textul wiki a suferit eventuale modificări nedorite.',
	...
	'visualeditor-preference-enable' => 'Activează EditorulVizual (doar în spațiile de nume [[{{int:visualeditor-mainnamespacepagelink}}|principal]] și [[{{int:visualeditor-usernamespacepagelink}}|utilizator]])',
	...
	'visualeditor-wikitext-warning' => 'Folosiți EditorulVizual — [[{{int:visualeditor-wikitext-warning-link}}|textul wiki]] nu funcționează aici. Apăsați „{{int:visualeditor-ca-editsource}}” pentru a modifica textul folosind codul sursă, adică textul wiki (modificările nesalvate se vor pierde).',
...
$messages['ru'] = array(
	...
	'tag-visualeditor' => '[[{{int:visualeditor-descriptionpagelink}}|Визуальный редактор]]',
	'tag-visualeditor-description' => 'Правка сделана с использованием [[{{int:Visualeditor-descriptionpagelink}}|визуального редактора]]', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|Визуальный редактор]]: проверить', # Fuzzy
	'tag-visualeditor-needcheck-description' => 'Правка с помощью [[{{int:Visualeditor-descriptionpagelink}}|визуального редактора]], в которой система обнаружила, возможно, непреднамеренно изменённый вики-текст.', # Fuzzy
	...
	'visualeditor-preference-enable' => 'Включить Визуальный редактор (только в [[{{int:visualeditor-mainnamespacepagelink}}|основном]] и [[{{int:visualeditor-usernamespacepagelink}}|личном]] пространствах)',
	...
	'visualeditor-wikitext-warning' => 'Вы используете VisualEditor — [[{{int:Visualeditor-wikitext-warning-link}}|вики-разметка]] здесь не работает. Нажмите «{{int:Visualeditor-ca-editsource}}» для редактирования страницы в режиме вики-текста. Несохранённые изменения будут утеряны.', # Fuzzy
 ...
 */
$messages['si'] = array(
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|දෘශ්‍ය සංස්කාරක]]', # Fuzzy
	'tag-visualeditor-description' => '[[{{int:Visualeditor-descriptionpagelink}}|දෘශ්‍යසංස්කාරක]] භාවිතා කොට සංස්කරණය සිදු කරන ලදී', # Fuzzy
...
$messages['sk'] = array(
	...
	'tag-visualeditor' => '[[{{int:visualeditor-descriptionpagelink}}|VisualEditor]]',
	'tag-visualeditor-description' => 'Úprava vykonaná pomocou [[{{int:visualeditor-descriptionpagelink}}|VisualEditoru]]',
	'tag-visualeditor-needcheck' => '[[{{int:visualeditor-descriptionpagelink}}|VisualEditor: Skontrolovať]]',
	'tag-visualeditor-needcheck-description' => 'Úprava vykonaná pomocou [[{{int:visualeditor-descriptionpagelink}}|VisualEditoru]], pri ktorej systém odhalil možné nezamýšľané zmeny wikitextu.',
	...
	'visualeditor-preference-enable' => 'Povoliť VisualEditor (len v [[{{int:visualeditor-mainnamespacepagelink}}|hlavnom]] a [[{{int:visualeditor-usernamespacepagelink}}|redaktorskom]] mennom priestore)',
	...
	'visualeditor-wikitext-warning' => 'Používate VisualEditor – [[{{int:visualeditor-wikitext-warning-link}}|wikitext]] tu nefunguje. Kliknutím na „{{int:visualeditor-ca-editsource}}“ môžete stránku upravovať v režime zdrojového kódu – o neuložené zmeny však prídete.',
...
$messages['sl'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-description' => 'Urejanje narejeno z [[{{int:Visualeditor-descriptionpagelink}}|VisualEditorjem]]', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor: Preveri]]', # Fuzzy
	'tag-visualeditor-needcheck-description' => 'Urejanje, narejeno z [[{{int:Visualeditor-descriptionpagelink}}|VisualEditorjem]], kjer je sistem zaznal, da ima wikibesedilo morda neželene spremembe.', # Fuzzy
	...
	'visualeditor-languageinspector-block-tooltip' => 'Jezikovni blok: $1$2',
	...
	'visualeditor-preference-enable' => 'Omogoči VisualEditor (samo v [[{{int:Visualeditor-mainnamespacepagelink}}|glavnem]] in [[{{int:Visualeditor-usernamespacepagelink}}|uporabniškem]] imenskem prostoru)', # Fuzzy
	...
	'visualeditor-wikitext-warning' => 'Uporabljate VisualEditor – [[{{int:Visualeditor-wikitext-warning-link}}|wikibesedilo]] tukaj ne deluje. Kliknite »{{int:Visualeditor-ca-editsource}}«, da uredite stran v načinu wikibesedila – neshranjene spremembe boste pri tem izgubili.', # Fuzzy
...
$messages['sr-ec'] = array(
	...
	'tag-visualeditor' => '[[{{int:visualeditor-descriptionpagelink}}|VisualEditor]]',
	'tag-visualeditor-description' => 'Измена направљена коришћењем [[{{int:visualeditor-descriptionpagelink}}|VisualEditor]]',
	'tag-visualeditor-needcheck' => '[[{{int:visualeditor-descriptionpagelink}}|VisualEditor: Check]]',
	...
	'visualeditor-languageinspector-block-tooltip' => 'Језички блок: $1$2',
...
$messages['sv'] = array(
	...
	'tag-visualeditor' => '[[{{int:visualeditor-descriptionpagelink}}|VisualEditor]]',
	'tag-visualeditor-description' => 'Redigering gjord med hjälp av [[{{int:visualeditor-descriptionpagelink}}|VisualEditor]]',
	'tag-visualeditor-needcheck' => '[[{{int:visualeditor-descriptionpagelink}}|VisualEditor: Kontrollera]]',
	'tag-visualeditor-needcheck-description' => 'Redigering gjord med [[{{int:visualeditor-descriptionpagelink}}|VisualEditor]] där systemet upptäckte att wikitexten möjligen hade oavsiktliga ändringar.',
	...
	'visualeditor-languageinspector-block-tooltip' => 'Språkblockering: $1$2',
	...
	'visualeditor-preference-enable' => 'Aktivera VisualEditor (endast i  [[{{int:visualeditor-mainnamespacepagelink}}|huvud-]] och [[{{int:visualeditor-usernamespacepagelink}}|användar]]namnrymderna)',
	...
	'visualeditor-wikitext-warning' => 'Du använder VisualEditor - [[{{int:visualeditor-wikitext-warning-link}}|wikitext]] fungerar inte här. Klicka på "{{int:visualeditor-ca-editsource}}" för att redigera sidan i wikitextläge – ändringar som inte har sparats kommer att förloras.',
...
$messages['sw'] = array(
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-description' => 'Kulihaririwa na [[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]: Pitia', # Fuzzy
	'visualeditor' => 'VisualEditor',
...
$messages['th'] = array(
	...
	'tag-visualeditor' => '[[{{int:visualeditor-descriptionpagelink}}|VisualEditor]]',
	'tag-visualeditor-description' => 'แก้ไขโดยใช้ [[{{int:visualeditor-descriptionpagelink}}|VisualEditor]]',
	'tag-visualeditor-needcheck' => '[[{{int:visualeditor-descriptionpagelink}}|VisualEditor: ตรวจสอบ]]',
	'tag-visualeditor-needcheck-description' => 'การแก้ไขโดยใช้ [[{{int:visualeditor-descriptionpagelink}}|VisualEditor]] ระบบตรวจพบ wikitext ที่อาจถูกเปลี่ยนแปลงโดยไม่ได้ตั้งใจ',
	...
	'visualeditor-languageinspector-block-tooltip' => 'บล็อกภาษา:$1$2',
	...
	'visualeditor-preference-enable' => 'เปิดใช้งาน VisualEditor (เฉพาะใน [[{{int:visualeditor-mainnamespacepagelink}}|เนมสเปซหลัก]] และ [[{{int:visualeditor-usernamespacepagelink}}|เนมสเปซผู้ใช้]])',
	...
	'visualeditor-wikitext-warning' => 'คุณกำลังใช้ VisualEditor-[[{{int:visualeditor-wikitext-warning-link}}|wikitext]] ทำงานไม่ได้ที่นี่ คลิก "{{int:visualeditor-ca-editsource}}" เพื่อแก้ไขหน้านี้ในโหมด wikitext – การเปลี่ยนแปลงที่ยังไม่ได้บันทึกจะสูญหาย',
	'visualeditor-wikitext-warning-link' => 'Help:Wiki markup',
...
$messages['tr'] = array(
	...
	'tag-visualeditor' => '[[{{int:visualeditor-descriptionpagelink}}|VisualEditor]]',
	'tag-visualeditor-description' => '[[{{int:visualeditor-descriptionpagelink}}|VisualEditor]] kullanarak düzenleyin',
	'tag-visualeditor-needcheck' => '[[{{int:visualeditor-descriptionpagelink}}|VisualEditor: Kontrol]]',
	...
	'visualeditor-editsummary' => 'Ne değiştirdiğinizi açıklayın',
	'visualeditor-feedback-link' => 'Project:VisualEditor/Feedback',
	...
	'visualeditor-languageinspector-block-tooltip' => 'Dil Bloğu: $1$2',
	'visualeditor-languageinspector-block-tooltip-rtldirection' => ': Sağdan sola',
	...
	'visualeditor-preference-enable' => "VisualEditor'u (sadece [[{{int:visualeditor-mainnamespacepagelink}}|main]] ve [[{{int:visualeditor-usernamespacepagelink}}|user]] isim uzaylarında) etkinleştir",
...
$messages['uk'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-description' => 'Редагування зроблено з використанням [[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor: перевірити]]', # Fuzzy
	'tag-visualeditor-needcheck-description' => 'Редагування з допомогою [[{{int:Visualeditor-descriptionpagelink}}|візуального редактора]], у якому система виявила вікітекст з, можливо, ненавмисними змінами.', # Fuzzy
	...
	'visualeditor-preference-enable' => 'Увімкнути візуальний редактор (лише в [[{{int:Visualeditor-mainnamespacepagelink}}|основному просторі назв]] та [[{{int:Visualeditor-usernamespacepagelink}}|просторі назв користувача]])', # Fuzzy
...
$messages['uz'] = array(
	...
	'visualeditor-preference-enable' => 'VisualEditorni yoqish (faqat [[{{int:Visualeditor-mainnamespacepagelink}}|asosiy]] va [[{{int:Visualeditor-usernamespacepagelink}}|foydalanuvchi]] nomfazolari uchun)', # Fuzzy
);
...
$messages['vec'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-description' => 'Canbiamento fato co [[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor: controłare]]', # Fuzzy
	'tag-visualeditor-needcheck-description' => "Canbiamento fato co [[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]] 'ndove el sistema el ga riłevà posibiłi canbiamenti no vołui inte'l wikitesto.", # Fuzzy
	...
	'visualeditor-preference-enable' => 'Abiłita VisualEditor (soło che inte i namespace [[{{int:Visualeditor-mainnamespacepagelink}}|prinsipałe]] e [[{{int:Visualeditor-usernamespacepagelink}}|Utente]])', # Fuzzy
	...
	'visualeditor-wikitext-warning' => 'Te si drio doparar VisualEditor - el [[{{int:Visualeditor-wikitext-warning-link}}|wikitesto]] no\'l funsiona cuà. Struca "{{int:Visualeditor-ca-editsource}}" par canbiar ła pàjina doparando el wikitesto (i canbiamenti no salvai i ndarà persi).', # Fuzzy
...
$messages['vi'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|Trình soạn thị giác]]', # Fuzzy
	'tag-visualeditor-description' => 'Đã sửa đổi dùng [[{{int:Visualeditor-descriptionpagelink}}|Trình soạn thị giác]]', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|Trình soạn thị giác: Cần kiểm tra]]', # Fuzzy
	'tag-visualeditor-needcheck-description' => 'Sửa đổi được thực hiện dùng [[{{int:Visualeditor-descriptionpagelink}}|Trình soạn thị giác]] (VisualEditor) và phần mềm nhận ra những thay đổi có thể bất ngờ trong văn bản wiki.', # Fuzzy
	...
	'visualeditor-beta-label' => 'beta',
	'visualeditor-beta-warning' => 'Trình soạn thị giác đang là “phiên bản beta”. Bạn có thể gặp trục trặc và có thể không sửa đổi một số phần của trang. Bấm “Sửa mã nguồn” để đổi qua chế độ sửa đổi văn bản wiki – các thay đổi không lưu sẽ bị mất.', # Fuzzy
	...
	'visualeditor-preference-enable' => 'Sử dụng Trình soạn thị giác (chỉ có trong các không gian tên [[{{int:Visualeditor-mainnamespacepagelink}}|chính]] và [[{{int:Visualeditor-usernamespacepagelink}}|thành viên]])', # Fuzzy
	...
	'visualeditor-wikitext-warning' => 'Bạn đang sử dụng Trình soạn thị giác – [[{{int:Visualeditor-wikitext-warning-link}}|văn bản wiki]] không phù hợp với trình soạn này. Bấm “{{int:Visualeditor-ca-editsource}}” để đổi qua chế độ sửa đổi văn bản wiki – các thay đổi không lưu sẽ bị mất.', # Fuzzy
...
$messages['yi'] = array(
	...
	'visualeditor-preference-enable' => 'אקטיוויזירן וויזועלער רעדאקטירער  (נאר אין [[{{int:Visualeditor-mainnamespacepagelink}}|הויפט נאמענטייל]] און אין [[{{int:Visualeditor-usernamespacepagelink}}|באַניצער נאמענטייל]])', # Fuzzy
...
$messages['zh-hans'] = array(
	...
	'tag-visualeditor' => '[[{{int:visualeditor-descriptionpagelink}}|VisualEditor]]',
	'tag-visualeditor-description' => '使用[[{{int:visualeditor-descriptionpagelink}}|VisualEditor]]进行的编辑',
	'tag-visualeditor-needcheck' => '[[{{int:visualeditor-descriptionpagelink}}|VisualEditor：检查]]',
	'tag-visualeditor-needcheck-description' => '系统检测到使用[[{{int:visualeditor-descriptionpagelink}}|VisualEditor]]进行编辑时可能发生有问题的更改。',
	...
	'visualeditor-preference-enable' => '启用可视化编辑器（仅在[[{{int:visualeditor-mainnamespacepagelink}}|主要]]和[[{{int:visualeditor-usernamespacepagelink}}|用户]]名字空间）',
	...
	'visualeditor-wikitext-warning' => '您正在使用VisualEditor - [[{{int:visualeditor-wikitext-warning-link}}|维基代码]]在这里无法工作。点击“{{int:visualeditor-ca-editsource}}”以使用维基代码模式编辑（所有未保存的更改将丢失）。',
...
$messages['zh-hant'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|視覺化編輯器]]', # Fuzzy
	'tag-visualeditor-description' => '使用 [[{{int:Visualeditor-descriptionpagelink}}|視覺化編輯器]] 所產生的編輯', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|可視化編輯器: 需要檢查]]', # Fuzzy
	'tag-visualeditor-needcheck-description' => '系統檢測到通過[[{{int:Visualeditor-descriptionpagelink}}|可視化編輯器]]所作出的編輯可能對維基文本作出未曾預料的更改。', # Fuzzy
	...
	'visualeditor-preference-enable' => '啟用 VisualEditor（僅在[[{{int:Visualeditor-mainnamespacepagelink}}|主]]名字空間和[[{{int:Visualeditor-usernamespacepagelink}}|使用者]]名字空間）', # Fuzzy
