...
$messages['bn'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|ভিজ্যুয়ালএডিটর]]', # Fuzzy
	'tag-visualeditor-description' => 'সম্পাদনাটি [[{{int:Visualeditor-descriptionpagelink}}|ভিজ্যুয়ালএডিটর]] ব্যবহার করে করা হয়েছে', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|ভিজ্যুয়ালএডিটর: পরীক্ষা করুন]]', # Fuzzy
	'tag-visualeditor-needcheck-description' => '[[{{int:Visualeditor-descriptionpagelink}}|ভিজ্যুয়ালএডিটর]] ব্যবহার করে সম্পাদনা যেখানে সিস্টেম সনাক্ত করেছে উইকিটেক্সটে সম্ভাব্য অনিচ্ছাকৃত পরিবর্তন হচ্ছে।', # Fuzzy
	...
	'visualeditor-beta-warning' => 'ভিজ্যুয়ালএডিটর এখন \'বেটা\'। আপনি সফটওয়্যারের সমস্যাগুলির সম্মুখীন হতে পারেন, এবং আপনি পাতার কিছু অংশ সম্পাদনা করতে সক্ষম নাও হতে পারেন। উইকটেক্সট মোডে ফিরতে "সম্পাদনা উৎস"-এ ক্লিক করুন - আপনার অসংরক্ষিত পরিবর্তনগুলি হারিয়ে যাবে।', # Fuzzy
	...
	'visualeditor-preference-enable' => 'ভিজ্যুয়ালএডিটর সক্রিয় করো (শুধুমাত্র [[{{int:Visualeditor-mainnamespacepagelink}}|প্রধান]] এবং [[{{int:Visualeditor-usernamespacepagelink}}|ব্যবহারকারী]] নামস্থানে)', # Fuzzy
	...
	'visualeditor-wikitext-warning' => 'আপনি ভিজ্যুয়ালএডিটর ব্যবহার করছেন - এখানে [[{{int:Visualeditor-wikitext-warning-link}}|উইকিটেক্সট]] কাজ করে না। উইকিটেক্সট মোডে পাতা সম্পাদনা করার জন্য "{{int:Visualeditor-ca-editsource}}য়" ক্লিক করুন - আপনার অসংরক্ষিত পরিবর্তনগুলি হারিয়ে যাবে।', # Fuzzy
 ...
 */
$messages['ce'] = array(
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|Визуальни тадарш дерг]]', # Fuzzy
	...
	'visualeditor-ca-editsource' => 'Нисде дӀадолалун йоза',
	'visualeditor-ca-editsource-section' => 'Нисде дӀадолалун йоза',
...
$messages['el'] = array(
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-description' => 'Επεξεργασία που έγινε με τη χρήση του [[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	...
	'visualeditor-preference-enable' => 'Ενεργοποίηση VisualEditor (μόνο για τους χώρους [[{{int:Visualeditor-mainnamespacepagelink}}|κύριο]] και [[{{int:Visualeditor-usernamespacepagelink}}|χρήστη]])', # Fuzzy
...
$messages['gl'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|Editor visual]]', # Fuzzy
	'tag-visualeditor-description' => 'Edición feita mediante o [[{{int:Visualeditor-descriptionpagelink}}|editor visual]]', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|Editor visual: Comprobar]]', # Fuzzy
	'tag-visualeditor-needcheck-description' => 'Edición feita mediante o [[{{int:Visualeditor-descriptionpagelink}}|editor visual]] na que o sistema detectou que o texto wiki posiblemente teña modificacións non intencionadas.', # Fuzzy
	...
	'visualeditor-beta-label' => 'beta',
	'visualeditor-beta-warning' => 'O editor visual está en fase beta. Pode atopar erros no software e partes da páxina que non se poden editar. Prema en "Editar a fonte" para cambiar ao modo de texto wiki; os cambios non gardados vanse perder.', # Fuzzy
	...
	'visualeditor-preference-enable' => 'Activar o editor visual (só nos espazos de nomes [[{{int:Visualeditor-mainnamespacepagelink}}|principal]] e de [[{{int:Visualeditor-usernamespacepagelink}}|usuario]])', # Fuzzy
	...
	'visualeditor-wikitext-warning' => 'Está usando o editor visual; o [[{{int:Visualeditor-wikitext-warning-link}}|texto wiki]] non funciona aquí. Preme en "{{int:Visualeditor-ca-editsource}}" para editar a páxina no modo de texto wiki (os cambios non gardados vanse perder).', # Fuzzy
...
$messages['ml'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|കണ്ടുതിരുത്തൽസൗകര്യം]]', # Fuzzy
	'tag-visualeditor-description' => '[[{{int:Visualeditor-descriptionpagelink}}|കണ്ടുതിരുത്തൽ സൗകര്യമുപയോഗിച്ച്]] നടത്തിയ തിരുത്തൽ', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|കണ്ടുതിരുത്തൽസൗകര്യം: പരിശോധിക്കുക]]', # Fuzzy
	'tag-visualeditor-needcheck-description' => '[[{{int:Visualeditor-descriptionpagelink}}|കണ്ടുതിരുത്തൽ സൗകര്യം]] ഉപയോഗിച്ച് തിരുത്തുമ്പോൾ വിക്കി എഴുത്ത് ഉൾപ്പെട്ടാൽ അപ്രതീക്ഷിത മാറ്റങ്ങൾ ഉണ്ടായേക്കാനിടയുണ്ട്.', # Fuzzy
	...
	'visualeditor-beta-warning' => 'കണ്ടുതിരുത്തൽ സൗകര്യം \'ബീറ്റ\' ആണ്. താങ്കൾക്ക് സോഫ്റ്റ്‌വേർ പ്രശ്നങ്ങൾ നേരിട്ടേക്കാം ഒപ്പം താളിലെ എല്ലാം തിരുത്താൻ കഴിഞ്ഞെന്ന് വരികയുമില്ല. "അടിസ്ഥാനരൂപം തിരുത്തുക" എന്നത് ഞെക്കി വിക്കിഎഴുത്ത് തിരുത്തൽ സൗകര്യം തിരിച്ച് കൊണ്ടുവരാവുന്നതാണ് - സേവ് ചെയ്യാത്ത മാറ്റങ്ങൾ അപ്പോൾ നഷ്ടപ്പെടുന്നതാണ്.', # Fuzzy
...
$messages['ms'] = array(
	...
	'visualeditor-annotationbutton-link-tooltip' => 'Pautan',
	'visualeditor-beta-label' => 'beta',
	'visualeditor-beta-warning' => 'VisualEditor berada dalam peringkat \'beta\'. Anda mungkin akan menghadapi masalah perisian serta tidak dapat menyunting sesetengah bahagian dalam halaman. Klik "Sunting sumber" untuk beralih ke mod wikiteks – sebarang suntingan yang belum disimpan akan disingkirkan.', # Fuzzy
...
$messages['pt-br'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-description' => 'Edição realizada utilizando o [[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|Editor Visual: Verificar]]', # Fuzzy
	'tag-visualeditor-needcheck-description' => 'Edição realizada com o [[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]] na qual o sistema detectou que o wikitexto possivelmente possui mudanças não planejadas.', # Fuzzy
	'tooltip-ca-createsource' => 'Criar o código fonte desta página',
	'tooltip-ca-editsource' => 'Editar o código fonte desta página',
	...
	'visualeditor-annotationbutton-link-tooltip' => 'Link',
	'visualeditor-beta-label' => 'beta',
	'visualeditor-beta-warning' => "O VisualEditor está em fase 'beta' e, por isso, pode não te deixar editar tudo ainda.", # Fuzzy
	...
	'visualeditor-preference-enable' => 'Ativar VisualEditor (apenas nos espaços nominais [[{{int:Visualeditor-mainnamespacepagelink}}|principal]] e de [[{{int:Visualeditor-usernamespacepagelink}}|usuário]])', # Fuzzy
...
$messages['sr-ec'] = array(
	...
	'visualeditor-help-label' => 'Кориснички водич', # Fuzzy
...
$messages['sv'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-description' => 'Redigering gjordes med hjälp av [[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor: Kontrollera]]', # Fuzzy
	'tag-visualeditor-needcheck-description' => 'Redigering gjord med [[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]] där systemet upptäckte att wikitexten möjligen hade oavsiktliga ändringar.', # Fuzzy
	...
	'visualeditor-beta-label' => 'beta',
	'visualeditor-beta-warning' => 'VisualEditor befinner sig i "betaversion". Du kan därför stöta på en del programvaruproblem och du kanske inte kan redigera delar av sidan. Klicka på "Redigera källa" för att byta till wikitext-läge – ändringar som inte sparats går förlorade.', # Fuzzy
	...
	'visualeditor-preference-enable' => 'Aktivera VisualEditor (endast i [[{{int:Visualeditor-mainnamespacepagelink}}|huvud]]- and [[{{int:Visualeditor-usernamespacepagelink}}|användar]]namnrymderna)', # Fuzzy
	...
	'visualeditor-wikitext-warning' => 'Du använder VisualEditor - [[{{int:Visualeditor-wikitext-warning-link}}|wikitext]] fungerar inte här. Klicka på "{{int:Visualeditor-ca-editsource}}" för att redigera sidan i wikitextläge – ändringar som inte har sparats kommer att förloras.', # Fuzzy
