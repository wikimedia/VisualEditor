 ...
 */
$messages['el'] = array(
	'guidedtour-tour-vegendersurvey-description' => "Με τη συμμετοχή σας σ' αυτή την έρευνα, αποδέχεστε τη μεταφορά των δεδομένων που αποστέλλετε στο ίδρυμα Wikimedia Foundatioν (στις Η.Π.Α. και οπουδήποτε αλλού). Οι συλλεγόμενες  πληροφορίες προορίζονται αποκλειστικά για εσωτερική ερευνητική χρήση και δεν πρόκειται να συνδεθούν, δημόσια, με τον λογαριασμό χρήστη σας. Όμως ενδέχεται να μοιραστούμε τα αποτελέσματα αυτής της έρευνας με το κοινό, σε μορφή ανώνυμης ή συγκεντρωτικής φόρμας.",
	...
	'visualeditor-formatdropdown-format-heading6' => 'Επίπεδο 7',
	...
	'visualeditor-reference-input-placeholder' => 'Για ποιό κείμενο θέλετε παραπομπή;',
	'visualeditor-referencelist-isempty' => 'Δεν υπάρχουν αναφορές με την ομάδα "$1" σε αυτή τη σελίδα.',
	'visualeditor-referencelist-missingref' => 'Η παραπομπή αυτή έχει οριστεί μέω προτύπου ή άλλου αυτόματα παραγόμενου μπλοκ και, προς το παρόν, δεν μπορείτε να την επεξεργαστείτε με τον VisualEditor. Χρησιμοποιήστε τον επεξεργαστή κώδικα.',
	'visualeditor-savedialog-error-badtoken' => 'Δεν μπορέσαμε να αξιοποιήσουμε την επεξεργασία σας γιατί η σύνοδος (session) δεν είναι πια έγκυρη.',
	'visualeditor-savedialog-identify-anon' => 'Θέλετε να αποθηκεύσετε αυτή τη σελίδα ως ανώνυμος χρήστης; Σε εκείνη την περίπτωση, θα καταγραφεί η IP σας στο ιστορικό της σελίδας.',
	'visualeditor-savedialog-identify-user' => 'Είστε {{GENDER:$1|συνδεδεμένος|συνδεδεμένη}} ως [[User:$1|$1]]. Η επεξεργασία σας θα συσχετιστεί με αυτόν τον λογαριασμό αν την αποθηκεύσετε.',
	...
	'visualeditor-serializeerror' => 'Σφάλμα κατά τη φόρτωση των δεδομένων από τον διακομιστή:  $1 .',
...
$messages['sk'] = array(
	...
	'visualeditor-annotationbutton-link-tooltip' => 'Odkaz',
	'visualeditor-beta-label' => 'beta',
	'visualeditor-beta-warning' => 'VisualEditor je v „betaverzii“. Môžete natrafiť na softvérové problémy a nemusíte byť schopní upravovať niektoré časti stránky. Kliknutím na „Upraviť zdroj“ sa môžete prepnúť do režimu zdrojového kódu (wikitextu) – neuložené zmeny budú stratené.',
	...
	'visualeditor-wikitext-warning' => 'Používate VisualEditor – [[{{int:visualeditor-wikitext-warning-link}}|wikitext]] tu nefunguje. Kliknutím na „{{int:visualeditor-ca-editsource}}“ môžete stránku upravovať v režime zdrojového kódu – neuložené zmeny budú stratené.',
...
$messages['sr-ec'] = array(
	...
	'visualeditor-beta-label' => 'бета',
	'visualeditor-browserwarning' => 'Користите прегледач који није званично подржан за VisualEditor.',
...
$messages['sv'] = array(
	...
	'tag-visualeditor' => '[[{{int:visualeditor-descriptionpagelink}}|VisualEditor]]',
	'tag-visualeditor-description' => 'Redigering gjord med hjälp av [[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
...
$messages['th'] = array(
	...
	'tooltip-ca-createsource' => 'สร้างรหัสต้นฉบับของเพจนี้',
	...
	'visualeditor-beta-label' => 'Beta',
	'visualeditor-beta-warning' => 'VisualEditor เป็น "เบต้า" คุณอาจพบปัญหาของซอฟต์แวร์ และคุณอาจไม่สามารถแก้ไขบางส่วนของหน้า คลิก "{{int:visualeditor-ca-editsource}}" เพื่อสลับไปที่โหมด wikitext – การเปลี่ยนแปลงยังไม่ได้บันทึกจะสูญหาย',
...
$messages['tr'] = array(
	'tag-visualeditor' => '[[{{int:visualeditor-descriptionpagelink}}|VisualEditor]]',
	'tag-visualeditor-description' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]] kullanılarak yapılan düzenleme', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor: İnceleme]]', # Fuzzy
	'visualeditor' => 'VisualEditor',
	...
	'visualeditor-beta-warning' => 'VisualEditor\'ün henüz "deneme" aşamasındadır ve bu nedenle her şeyi düzenlemenize izin vermeyebilir.', # Fuzzy
	...
	'visualeditor-help-label' => 'Kullanıcı rehberi', # Fuzzy
