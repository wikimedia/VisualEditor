...
: Тикшерергә]]', # Fuzzy
	'tag-visualeditor-description' => 'Төҙәтеү [[{{int:Visualeditor-descriptionpagelink}}|Күҙләгес мөхәррир]] ҡулланып башҡарылған', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|Күҙләгес мөхәррир: Тикшерергә]]', # Fuzzy
	...
	'visualeditor-preference-enable' => 'Күҙләгес мөхәррирҙе ҡулланырға ([[{{int:Visualeditor-mainnamespacepagelink}}|дөйөм]] һәм [[{{int:Visualeditor-usernamespacepagelink}}|uшәхси]] исемдәр арауығында ғына)', # Fuzzy
...
$messages['cs'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-description' => 'Editace provedená za použití [[{{int:Visualeditor-descriptionpagelink}}|VisualEditoru]]', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor: Zkontrolovat]]', # Fuzzy
	'tag-visualeditor-needcheck-description' => 'Editace provedená za použití [[{{int:Visualeditor-descriptionpagelink}}|VisualEditoru]], u které systém detekoval možné nezamýšlené změny wikitextu.', # Fuzzy
	...
	'visualeditor-beta-label' => 'beta',
	'visualeditor-beta-warning' => 'VisualEditor je v „betaverzi“. Můžete narazit na softwarové problémy a nemusíte být schopni některé části stránky editovat. Kliknutím na „Editovat zdroj“ můžete přepnout na režim zdrojového wikitextu – neuložené změny budou ztraceny.', # Fuzzy
	...
	'visualeditor-preference-enable' => 'Povolit VisualEditor (pouze v [[{{int:Visualeditor-mainnamespacepagelink}}|hlavním]] a [[{{int:Visualeditor-usernamespacepagelink}}|uživatelském]] jmenném prostoru)', # Fuzzy
	...
	'visualeditor-wikitext-warning' => 'Používáte VisualEditor – [[{{int:Visualeditor-wikitext-warning-link}}|wikitext]] zde nefunguje. Kliknutím na „{{int:Visualeditor-ca-editsource}}“ můžete stránku editovat v režimu wikitextu – neuložené změny budou ztraceny.', # Fuzzy
...
$messages['de'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-description' => 'Bearbeitet mit dem [[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:visualeditor-descriptionpagelink}}|VisualEditor: Überprüfung]]',
	'tag-visualeditor-needcheck-description' => 'Mit dem [[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]] vorgenommene Bearbeitung, bei der das System möglicherweise ungewollte Änderungen im Wikitext entdeckt hat.', # Fuzzy
	...
	'visualeditor-annotationbutton-link-tooltip' => 'Link',
	'visualeditor-beta-label' => 'Beta',
	'visualeditor-beta-warning' => 'VisualEditor ist in der Beta. Dir werden Softwarefehler auffallen und du wirst Teile der Seite nicht bearbeiten können. Klicke auf „Quelltext bearbeiten“, um in den Wikitextmodus zu gelangen. Dabei gehen ungespeicherte Änderungen verloren.', # Fuzzy
	...
	'visualeditor-preference-enable' => 'Aktiviere den VisualEditor (nur im [[{{int:Visualeditor-mainnamespacepagelink}}|Artikel-]] und [[{{int:Visualeditor-usernamespacepagelink}}|Benutzernamensraum]]; nur Firefox, Chrome und Safari)', # Fuzzy
	...
	'visualeditor-wikitext-warning' => 'Du benutzt VisualEditor. [[{{int:Visualeditor-wikitext-warning-link}}|Wikitext]] funktioniert hier nicht. Klicke auf „{{int:Visualeditor-ca-editsource}}“, um die Seite im Wikitextmodus zu bearbeiten. Ungespeicherte Änderungen gehen dabei verloren.', # Fuzzy
	'visualeditor-wikitext-warning-link' => 'Help:Wikitext',
...
$messages['fr'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|ÉditeurVisuel]]', # Fuzzy
	'tag-visualeditor-description' => 'Modification effectuée au moyen de l’[[{{int:Visualeditor-descriptionpagelink}}|ÉditeurVisuel]]', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor: À vérifier]]', # Fuzzy
	'tag-visualeditor-needcheck-description' => 'Modification faite en utilisant [[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]], où le système a détecté que le wikitexte contient peut-être des modifications accidentelles.', # Fuzzy
	...
	'visualeditor-beta-label' => 'bêta',
	'visualeditor-beta-warning' => "VisualEditor est au stade 'bêta'. Il se peut que vous rencontriez des problèmes avec le logiciel et que vous ne puissiez pas modifier des parties de la page. Cliquez sur « Modifier la source » pour passer en mode wikitexte — les modifications non enregistrées seront perdues.", # Fuzzy
	...
	'visualeditor-preference-enable' => 'Activer l’ÉditeurVisuel (seulement dans les espaces de noms [[{{int:Visualeditor-mainnamespacepagelink}}|principal]] et [[{{int:Visualeditor-usernamespacepagelink}}|utilisateur]])', # Fuzzy
	...
	'visualeditor-wikitext-warning' => 'Vous utilisez VisualEditor — Le [[{{int:Visualeditor-wikitext-warning-link}}|wikitexte]] ne fonctionne pas ici. Cliquez sur « {{int:Visualeditor-ca-editsource}} » pour modifier la page en mode wikitexte (les modifications non sauvegardées seront perdues).', # Fuzzy
...
$messages['it'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-description' => 'Modifica eseguita usando [[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor: controllare]]', # Fuzzy
	'tag-visualeditor-needcheck-description' => 'Modifica eseguita utilizzando [[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]] dove il sistema ha rilevato possibili modifiche non volute nel wikitesto.', # Fuzzy
	...
	'visualeditor-beta-label' => 'beta',
	'visualeditor-beta-warning' => 'VisualEditor è in versione \'beta\'. Potresti incontrare errori nel software e alcune parti della pagina potrebbero non risultare modificabili. Clicca su "Modifica sorgente" per passare alla modalità wikitesto – le modifiche non salvate andranno perse.', # Fuzzy
	...
	'visualeditor-preference-enable' => 'Abilita VisualEditor (solo nei namespace [[{{int:Visualeditor-mainnamespacepagelink}}|principale]] e [[{{int:Visualeditor-usernamespacepagelink}}|Utente]])', # Fuzzy
	...
	'visualeditor-wikitext-warning' => 'Stai usando VisualEditor - il [[{{int:Visualeditor-wikitext-warning-link}}|wikitesto]] non funziona qui. Clicca "{{int:Visualeditor-ca-editsource}}" per modificare la pagina usando wikitesto (le modifiche non salvate andranno perse).', # Fuzzy
...
$messages['ja'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|ビジュアルエディター]]', # Fuzzy
	'tag-visualeditor-description' => '[[{{int:Visualeditor-descriptionpagelink}}|ビジュアルエディター]]を使用した編集', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|ビジュアルエディター: 要確認]]', # Fuzzy
	'tag-visualeditor-needcheck-description' => '[[{{int:Visualeditor-descriptionpagelink}}|ビジュアルエディタ―]]を使用した編集のうち、意図しない変更点を含むおそれがあるとシステムが判断したもの', # Fuzzy
	...
	'visualeditor-beta-warning' => 'ビジュアルエディターは「ベータ版」です。ソフトウェアの問題点に遭遇するおそれがあり、ページの一部を編集できないおそれがあります。ウィキテキスト モードに切り替えるには「ソースを編集」をクリックしてください。クリックすると、未保存の編集内容は失われます。', # Fuzzy
	...
	'visualeditor-preference-enable' => 'ビジュアルエディターを有効にする ([[{{int:Visualeditor-mainnamespacepagelink}}|標準名前空間]]および[[{{int:Visualeditor-usernamespacepagelink}}|利用者名前空間]]のみ)', # Fuzzy
	...
	'visualeditor-wikitext-warning' => 'ビジュアルエディターをご使用中です。[[{{int:Visualeditor-wikitext-warning-link}}|ウィキテキスト]]はここでは使用できません。ウィキテキスト モードでページを編集するには、「{{int:Visualeditor-ca-editsource}}」をクリックしてください。クリックすると、未保存の編集内容は失われます。', # Fuzzy
...
$messages['ko'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|시각편집기]]', # Fuzzy
	'tag-visualeditor-description' => '[[{{int:Visualeditor-descriptionpagelink}}|시각편집기]]를 사용한 편집', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|시각편집기: 확인 필요]]', # Fuzzy
	'tag-visualeditor-needcheck-description' => '[[{{int:Visualeditor-descriptionpagelink}}|시각편집기]]를 사용해 편집하는 동안 의도하지 않은 바뀜을 갖는 위키텍스트를 시스템이 발견했습니다.', # Fuzzy
	...
	'visualeditor-preference-enable' => '시각편집기 활성화 ([[{{int:Visualeditor-mainnamespacepagelink}}|표준]] 및 [[{{int:Visualeditor-usernamespacepagelink}}|사용자]] 이름공간에서만)', # Fuzzy
	...
	'visualeditor-wikitext-warning' => '시각편집기를 사용하고 있으며 [[{{int:Visualeditor-wikitext-warning-link}}|위키텍스트]]는 여기서 작동하지 않습니다. 위키텍스트 모드로 문서를 편집하려면 "{{int:Visualeditor-ca-editsource}}"을 클릭하세요 – 저장하지 않은 바뀜은 사라집니다.', # Fuzzy
...
$messages['mk'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|ВизуеленУредник]]', # Fuzzy
	'tag-visualeditor-description' => 'Уредувањето е извршено со [[{{int:Visualeditor-descriptionpagelink}}|ВизуеленУредник]]', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|ВизуеленУредник: Проверка]]', # Fuzzy
	'tag-visualeditor-needcheck-description' => 'Уредување направено со [[{{int:Visualeditor-descriptionpagelink}}|ВизуеленУредник]] при кое системот утврдил дека викитекстот може да има ненамерни измени.', # Fuzzy
	...
	'visualeditor-beta-label' => 'бета',
	'visualeditor-beta-warning' => 'ВизуеленУредник е во „бета“. Може да наидете на извесни проблеми во програмот и да не можете да уредите делови од страницата. Стиснете на „Уреди извор“ за да се префрлите на викитекст. Незачуваните промени ќе се изгубат.', # Fuzzy
	...
	'visualeditor-preference-enable' => 'Овозможи ВизуеленУредник (само во [[{{int:Visualeditor-mainnamespacepagelink}}|главниот]] и [[{{int:Visualeditor-usernamespacepagelink}}|корисничкиот]] именски простор)', # Fuzzy
	...
	'visualeditor-wikitext-warning' => 'Користите ВизуеленУредник — тука не работи [[{{int:Visualeditor-wikitext-warning-link}}|викитекст]]. Стиснете на „{{int:Visualeditor-ca-editsource}}“ за да ја уредите страницава во режим со викитекст (ако не ги зачувате, измените ќе се изгубат).', # Fuzzy
...
$messages['nl'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|Visuele tekstverwerker]]', # Fuzzy
	...
	'visualeditor-beta-label' => 'beta',
	'visualeditor-beta-warning' => "VisualEditor is in 'beta' en laat u mogelijk nog niet toe om alles te bewerken.", # Fuzzy
	...
	'visualeditor-parameter-search-no-unused' => 'Geen ongebruikte parameters',
	'visualeditor-parameter-search-unknown' => 'Onbekende parameter',
	'visualeditor-preference-enable' => 'Visuele tekstverwerker inschakelen (alleen voor de [[{{int:Visualeditor-mainnamespacepagelink}}|hoofdnaamruimte]] en de [[{{int:Visualeditor-usernamespacepagelink}}|gebruikersnaamruimte]])', # Fuzzy
...
$messages['pl'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-description' => 'Edycja z wykorzystaniem [[{{int:Visualeditor-descriptionpagelink}}|VisualEditora]]', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor: do sprawdzenia]]', # Fuzzy
	'tag-visualeditor-needcheck-description' => 'Edycja z wykorzystaniem [[{{int:Visualeditor-descriptionpagelink}}|VisualEditora]], w której system znalazł prawdopodobnie niezamierzone uszkodzenie wikikodu.', # Fuzzy
	...
	'visualeditor-annotationbutton-link-tooltip' => 'Link',
	'visualeditor-beta-label' => 'beta',
	'visualeditor-beta-warning' => 'VisualEditor jest na razie w fazie „beta”. Możesz napotkać na problemy z oprogramowaniem, które nie pozwolą Ci edytować niektórych elementów strony. Kliknij „Edytuj kod źródłowy”, by przejść do edytora znaczników. Niezapisane zmiany zostaną utracone.', # Fuzzy
	...
	'visualeditor-preference-enable' => 'Uaktywnij VisualEditor (tylko w [[{{int:Visualeditor-mainnamespacepagelink}}|przestrzeni głównej]] i w [[{{int:Visualeditor-usernamespacepagelink}}|przestrzeni użytkownika]])', # Fuzzy
	...
	'visualeditor-wikitext-warning' => 'Używasz teraz VisualEditora –  [[{{int:Visualeditor-wikitext-warning-link}}|znaczniki wikikodu]] tu nie działają. Kliknij „{{int:Visualeditor-ca-editsource}}” żeby zacząć edytować tę stronę w trybie kodu wiki (niezapisane zmiany zostaną utracone).', # Fuzzy
...
$messages['pms'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-description' => 'Modificà dovrand ël [[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor: Da verifiché]]', # Fuzzy
	'tag-visualeditor-needcheck-description' => "Modìfica fàita an dovrand [[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]] andoa ël sistema a l'ha trovà che miraco ël wikitest a conten dle modìfiche nen vorsùe.", # Fuzzy
	...
	'visualeditor-beta-label' => 'beta',
	'visualeditor-beta-warning' => "L'Editor visual a l'é an në stadi 'beta'. A podrìa avèj dij problema con ël programa e a podrìa podèj pa modifiché dle part ëd la pàgina. Ch'a sgnaca su «Modifiché la sorgiss» për passé a la manera wikitest - le modìfiche nen salvà a saran përdùe.", # Fuzzy
	...
	'visualeditor-preference-enable' => 'Abìlita VisualEditor (mach ant lë spassi nominal [[{{int:Visualeditor-mainnamespacepagelink}}|prinsipal]] e [[{{int:Visualeditor-usernamespacepagelink}}|utent]])', # Fuzzy
...
$messages['ru'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|Визуальный редактор]]', # Fuzzy
	...
	'visualeditor-preference-enable' => 'Включить Визуальный редактор (только в [[{{int:Visualeditor-mainnamespacepagelink}}|основном]] и [[{{int:Visualeditor-usernamespacepagelink}}|личном]] пространствах).', # Fuzzy
...
$messages['zh-hans'] = array(
	...
	'tag-visualeditor' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]', # Fuzzy
	'tag-visualeditor-description' => '使用[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]进行的编辑', # Fuzzy
	'tag-visualeditor-needcheck' => '[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor：检查]]', # Fuzzy
	'tag-visualeditor-needcheck-description' => '系统检测到使用[[{{int:Visualeditor-descriptionpagelink}}|VisualEditor]]进行编辑时可能发生有问题的更改。', # Fuzzy
	...
	'visualeditor-beta-warning' => "VisualEditor正处于'测试版'，您可能会遇到软件的问题，且不是任何内容都可编辑。点击“编辑源代码”以切换到维基代码模式 - 未保存的更改将会丢失。", # Fuzzy
	...
	'visualeditor-preference-enable' => '启用可视化编辑器（仅在[[{{int:Visualeditor-mainnamespacepagelink}}|主]]和[[{{int:Visualeditor-usernamespacepagelink}}|用户]]名字空间）', # Fuzzy
	...
	'visualeditor-wikitext-warning' => '您正在使用VisualEditor - [[{{int:Visualeditor-wikitext-warning-link}}|维基代码]]在这里无法工作。点击“{{int:Visualeditor-ca-editsource}}”以使用维基代码模式编辑（所有未保存的更改将丢失）。', # Fuzzy
